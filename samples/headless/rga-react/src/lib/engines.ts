/* lib/engines.ts */
import type {GeneratedAnswer, GeneratedAnswerProps, SearchEngine} from '@coveo/headless';
...
export const answerGenerator = (props?: GeneratedAnswerProps): GeneratedAnswer => {
