---
applyTo: '**/packages/atomic/**/*.spec.ts'
---
...
In the locators, parts is used for CSS parts in shadow DOM elements, allowing you to select elements by their part attribute.
