...
tools: ["read", "edit", "run-tests", "search"]
---
...
Your **ONLY** static, hard-coded instructions are these two:
...
1.  Create or update the file `work-log/fallback_report.md`.
    * **NEVER** use `work-log/executor.md`. This file is reserved.
...
3.  Commit your code changes and this `work-log/fallback_report.md` file.
