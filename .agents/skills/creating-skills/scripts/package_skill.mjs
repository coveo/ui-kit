 ...
 *
 * Example:
 *     node package_skill.mjs .agents/skills/my-skill
 *     node package_skill.mjs .agents/skills/my-skill ./dist
 */
...
async function main() {
  ...
  if (args.length < 1) {
    ...
    console.log('  node package_skill.mjs .agents/skills/my-skill ./dist');
