...
const activitySnapshot: ConverseEvent = {
  ...
  data: {
    ...
    timestamp: 1781727548336,
    messageId: 'activity-c117b1e097bf41d2a28ef354dd0841ad',
    ...
    content: {
      ...
      results: [
        ...
        {
          title:
            'The Past, Present and Future of Ski Tubes – Barca Sports Blog',
...
const response7Events: ConverseEvent[] = buildActivityOnlyResponse({
  runId,
  activitySnapshot,
});
