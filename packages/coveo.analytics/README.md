...
You have to provide your own `fetch` API compatible libraries in the global environment (see [Isomorphic TypeScript, fetch, promises, ava and coverage] article (http://source.coveo.com/2016/05/11/isomorphic-typescript-ava-w-coverage/))
