...
You need an Coveo Cloud organization API key that has the permission to write to the usage analytics sevice.
  ...
  * When using [Coveo Cloud V2](https://platform.cloud.coveo.com/login), create the API key from the [administration console] (https://platform.cloud.coveo.com/admin/#/organization/api-access/) selecting the Edit check box for the Analytics data privilege (see [API Access - Page](http://www.coveo.com/go?dest=ccv2ac&context=27)).
