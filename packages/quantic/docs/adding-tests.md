...
Now you are ready to write the Cypress tests for your component. All tests should be added in `cypress/integration`. For our example, we create the file `cypress/integration/quantic-greeting.cypress.ts`.
