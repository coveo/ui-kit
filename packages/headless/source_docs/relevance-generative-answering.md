...
This articles guides you through the process of integrating [Coveo RGA](https://docs.coveo.com/en/n9de0370/) in a front-end app with the [`@coveo/headless`](https://docs.coveo.com/en/headless/latest/) library.
...
{ @includeCode ../../../samples/headless/headless-rga-react/src/components/Quickstart.tsx }
</details>
...
> [!WARNING]
> 
> Currently, only [`SearchEngine`](https://docs.coveo.com/en/headless/latest/reference/functions/Search.SearchEngine.html) and [`InsightEngine`](https://docs.coveo.com/en/headless/latest/reference/functions/Insight.InsightEngine.html) supports RGA.
...
{ @includeCode ../../../samples/headless/headless-rga-react/src/lib/getSearchEngine.ts }
...
The RGA generates responses based on the context of the query submitted to the engine.
...
{ @includeCode ../../../samples/headless/headless-rga-react/src/lib/getAnswerGenerator.ts }
...
{ @includeCode ../../../samples/headless/headless-rga-react/src/lib/engines.ts }
...
{ @includeCode ../../../samples/headless/headless-rga-react/src/components/AnswerGenerator.tsx }
...
| --- | --- | --: |
| [`openFeedbackModal()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#openfeedbackmodal) | Sets `feedbackModalOpen` to true. | icon:x[alt=x,width=32,role=red] |
| [`closeFeedbackModal()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#closefeedbackmodal) | Sets `feedbackModalOpen` to false. | icon:x[alt=x,width=32,role=red] |
| [`like()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#like) | Marks the generated answer as liked. | icon:check[alt=check,width=32,role=green] Logs like event |
| [`dislike()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#dislike) | Marks the generated answer as disliked. | icon:check[alt=check,width=32,role=green] Logs dislike event |
| [`sendFeedback(feedback: GeneratedAnswerFeedback)`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#sendfeedback) | Submits user feedback and sets `feedbackSubmitted` to true. | icon:check[alt=check,width=32,role=green] Logs feedback event |
| [`show()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#show) | Marks the answer as visible. | icon:check[alt=check,width=32,role=green] Logs show event |
| [`hide()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#hide) | Marks the answer as hidden. | icon:check[alt=check,width=32,role=green] Logs hide event |
| [`expand()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#expand) | Marks the answer as expanded to show full response. | icon:check[alt=check,width=32,role=green] Logs expand event |
| [`collapse()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#collapse) | Marks the answer as collapsed to show partial response. | icon:check[alt=check,width=32,role=green] Logs collapse event |
| [`enable()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#enable) | Enables the generated answer feature. | icon:x[alt=x,width=32,role=red] |
| [`disable()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#disable) | Disables the generated answer feature. | icon:x[alt=x,width=32,role=red] |
| [`logCitationClick(citationId: string)`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#logcitationclick) | icon:x[alt=x,width=32,role=red] | icon:check[alt=check,width=32,role=green] Logs citation click event |
| [`logCitationHover(citationId: string, timeMs: number)`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#logcitationhover) | icon:x[alt=x,width=32,role=red] | icon:check[alt=check,width=32,role=green] Logs citation hover event |
| [`logCopyToClipboard()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#logcopytoclipboard) | icon:x[alt=x,width=32,role=red] | icon:check[alt=check,width=32,role=green] Logs copy-to-clipboard event |
| [`retry()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswer.html#retry) | Tries to generate an answer again. | icon:x[alt=x,width=32,role=red] |
...
{ @includeCode ../../../samples/headless/headless-rga-react/src/components/CitationsList.tsx }
...
| Method | Analytics |
| --- | --- |
| [`beginDelayedSelect()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.buildInteractiveCitation.html#begindelayedselect) | icon:check[alt=check,width=32,role=green] Prepares to log selection event |
| [`cancelPendingSelect()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.buildInteractiveCitation.html#cancelpendingselect) | icon:check[alt=check,width=32,role=green] Cancels the pending selection of `beginDelayedSelect` |
| [`select()`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.buildInteractiveCitation.html#select) | icon:check[alt=check,width=32,role=green] Logs the selection event |

In order to track user’s interactions with results, you need to instantiate the [`InteractiveCitation`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.InteractiveCitation.html) with the specific [`GeneratedAnswerCitation`](https://docs.coveo.com/en/headless/latest/reference/interfaces/Search.GeneratedAnswerCitation.html) being interacted with.
Once these events has been integration with your code, these events can be accessed in your [Coveo RGA reports](https://docs.coveo.com/en/nb6a0210/).
...
{ @includeCode ../../../samples/headless/headless-rga-react/src/components/Citation.tsx }
...
{ @includeCode ../../../samples/headless/headless-rga-angular/src/app/coveo-headless-rga.service.ts }

{ @includeCode ../../../samples/headless/headless-rga-angular/src/app/coveo-headless-rga.component.ts }

{ @includeCode ../../../samples/headless/headless-rga-angular/src/app/coveo-headless-rga.component.html }
</details>
...
{ @includeCode ../../../samples/headless/headless-rga-native/index.js }