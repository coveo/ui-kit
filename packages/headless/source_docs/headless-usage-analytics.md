...
Since version 2.80.0, Coveo Headless supports two tracking protocols: the [Coveo UA Protocol](./coveo-ua.html) and the new [Event Protocol (EP)](./event-protocol.html).
