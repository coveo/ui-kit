...
import {SortByFields, SortCriterion, sortCriterionDefinition, SortByFieldsFields, SortByRelevance, SortBy, buildRelevanceSortCriterion, SortDirection, buildFieldsSortCriterion} from '../../../../features/sort/sort';
...
import {registerSortCriterion, updateSortCriterion} from '../../../../features/sort/sort-actions';
...
function validateSortInitialState(
  engine: CoreEngine<ProductListingV2Section & StructuredSortSection>,
...
export function buildSort(
  ...
  return {
    ...
    get state() {
      const {appliedSort, availableSorts} = getState();
      return {
        appliedSort,
        availableSorts
      };
