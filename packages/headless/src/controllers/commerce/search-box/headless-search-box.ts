...
import {Delimiters, SuggestionHighlightingOptions} from '../../../utils/highlight';
import {buildController, Controller} from '../../controller/headless-controller';
import {getSuggestions, SearchBoxState, Suggestion,} from '../../core/search-box/headless-core-search-box';
import {CommerceEngine} from '../../../app/commerce-engine/commerce-engine';
import {loadReducerError} from '../../../utils/errors';
import {randomID} from '../../../utils/utils';
import {validateOptions} from '../../../utils/validate-payload';
import {registerQuerySetQuery, updateQuerySetQuery} from '../../../features/query-set/query-set-actions';
import {
...
import {defaultSearchBoxOptions, SearchBoxOptions, searchBoxOptionsSchema} from './headless-search-box-options';
...
import {deselectAllBreadcrumbs, deselectAllNonBreadcrumbs} from '../../../features/breadcrumb/breadcrumb-actions';
...
export function buildSearchBox(
  ...
  dispatch(registerQuerySetQuery({id, query: engine.state.commerceQuery.query ?? ''}));
...
function loadSearchBoxReducers(
  ...
  CommerceSearchSection
> {
  engine.addReducers({commerceQuery, querySuggest, configuration, querySet, commerceSearch});
  return true;
}
