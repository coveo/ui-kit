...
describe('LocationFacetSearch', () => {
  const facetId: string = 'location_facet_id';
  let engine: MockedCommerceEngine;
  let props: LocationFacetSearchProps;
  let facetSearch: LocationFacetSearch;
  ...
  function initFacetSearch() {
    facetSearch = buildLocationFacetSearch(engine, props);
  }
