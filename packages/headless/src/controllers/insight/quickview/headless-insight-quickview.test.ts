...
import {
  buildInsightQuickview,
  InsightQuickviewOptions,
  InsightQuickview,
} from './headless-insight-quickview';

describe('InsightQuickview', () => {
  let engine: MockInsightEngine;
  let options: InsightQuickviewOptions;
  let quickview: InsightQuickview;

  function initQuickview() {
    quickview = buildInsightQuickview(engine, {options});
  }
