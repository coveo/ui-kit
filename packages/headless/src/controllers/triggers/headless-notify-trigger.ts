...
/**
 * The `NotifyTrigger` controller handles notify triggers. A [Notify trigger] (https://docs.coveo.com/en/3413/tune-relevance/manage-trigger-rules#notify) query pipeline rule lets you define a message to be displayed to the end user when a certain condition is met.
 */
