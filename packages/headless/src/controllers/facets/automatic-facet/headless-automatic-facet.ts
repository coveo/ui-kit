 ...
 *
 * It's important to note that this controller is not typically used directly.
 * It is internally used by the `AutomaticFacetGenerator` controller to automatically render updated facets.
 *
