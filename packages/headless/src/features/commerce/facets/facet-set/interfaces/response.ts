...
interface FacetValueMetadata {
  numberOfResults: number;
  isAutoSelected: boolean;
  isSuggested: boolean;
}

export interface CategoryFacetValue extends BaseFacetValue, FacetValueMetadata {
  value: string;
  path: string[];
  isLeafValue: boolean;
...
export interface RegularFacetValue extends BaseFacetValue, FacetValueMetadata {
  value: string;
  /**
...
interface RangeFacetValue<T> extends BaseFacetValue, FacetValueMetadata {
  start: T;
  end: T;
