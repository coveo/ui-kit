...
export interface ResultTemplatesManager<Content = unknown> {
   ...
   * @param templates A list of templates to register.
   */
   ...
   * @param result The result for which to select a template.
   * @returns The selected template's content, or null if no template's conditions are satisfied.
   */
 ...
 * @param engine The `HeadlessEngine` instance of your application.
 * @returns A new result templates manager.
 * @docsection Result Templates Manager
 */
