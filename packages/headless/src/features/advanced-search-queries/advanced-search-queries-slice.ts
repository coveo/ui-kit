...
import {AdvancedSearchQueriesState, getAdvancedSearchQueriesInitialState} from './advanced-search-queries-state.js';

export const advancedSearchQueriesReducer: Reducer<AdvancedSearchQueriesState> = createReducer(
