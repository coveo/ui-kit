...
export const buildSearchRequest = async (state: StateNeededBySearchRequest) => {
  ...
  // Corner case:
  // If the number of results requested would go over the index limits (typically 5000 results is the maximum you can reach)
