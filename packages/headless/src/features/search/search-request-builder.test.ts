...
describe('search request', () => {
  ...
  it(`when a category facet request has #currentValues,
  #searchRequestParams returns the facets with #numberOfValues set to 1`, () => {
    const currentValues = [buildMockCategoryFacetValueRequest()];
