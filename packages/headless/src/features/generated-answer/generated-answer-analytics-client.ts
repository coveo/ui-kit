import type {CustomAction, LegacySearchAction} from '../analytics/analytics-utils.js';
 ...
 * implementation is registered as a thunk extra argument at engine-build time.
 *
 * @group Controllers
