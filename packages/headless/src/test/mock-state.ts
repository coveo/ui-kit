...
import {getAutomaticFacetsSetInitialState} from '../features/facets/automatic-facet-set/automatic-facet-set-state';
...
export function createMockState(
  ...
  return {
    ...
    automaticFacetsSet: getAutomaticFacetsSetInitialState(),
    ...config,
  };
}
