...
import {getAutomaticFacetsInitialState} from '../features/facets/automatic-facet-set/automatic-facet-set-state';
...
export function createMockState(
  ...
  return {
    ...
    automaticFacets: getAutomaticFacetsInitialState(),
    ...config,
  };
}
