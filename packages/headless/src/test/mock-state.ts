...
import {getStandaloneSearchBoxInitialState} from '../features/standalone-search-box-set/standalone-search-box-set-state';
...
export function createMockState(
  ...
  return {
    ...
    standaloneSearchBoxSet: getStandaloneSearchBoxInitialState(),
    ...config,
  };
}
