...
import {buildProductRecommendationsRequest} from '../../features/product-recommendations/product-recommendations-actions.js';
...
import {PlatformClient, PlatformClientCallOptions} from '../platform-client.js';
...
describe('search api client', () => {
  ...
  describe('middleware', () => {
    ...
    it('should preprocess query suggest responses if appropriate middleware is provided', async () => {
      ...
      const req = await buildQuerySuggestRequest('test', state);
