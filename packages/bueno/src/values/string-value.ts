  ...
  implements SchemaValue<string>
{
  ...
  public validate(value: T) {
    ...
    /**
     * TODO July 2026: Replace by URL.canParse() https://developer.mozilla.org/en-US/docs/Web/API/URL/canParse_static
     * (Baseline wide compatibility: https://caniuse.com/url)
     */
    if (url) {
      try {
        new URL(value);
