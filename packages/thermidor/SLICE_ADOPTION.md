...
> Part of the `@coveo/thermidor` [architecture](docs/architecture.md). See the [glossary](docs/glossary.md) for term definitions.
...
```typescript
import {initialize} from '@coveo/thermidor/core';
