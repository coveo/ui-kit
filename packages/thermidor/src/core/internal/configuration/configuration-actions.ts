...
export const setOrganizationId = createAction<string>(
  `${ACTION_PREFIX}/setOrganizationId`
);

export const setAccessToken = createAction<string>(
  `${ACTION_PREFIX}/setAccessToken`
);

export const setTrackingId = createAction<string>(
  `${ACTION_PREFIX}/setTrackingId`
);
...
export const setEndpoint = createAction<string | undefined>(
  `${ACTION_PREFIX}/setEndpoint`
);
