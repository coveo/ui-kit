...
- Ensure that any architectural changes you suggest or make satisfy the requirements of `thermidor/docs/internal/adr/ADR-010-architecture-decision-charter-v2.md` (the current charter, which supersedes the deprecated `ADR-000-architecture-decision-charter.md`).
