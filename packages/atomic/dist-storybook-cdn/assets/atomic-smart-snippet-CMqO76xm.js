import{n as e}from"./chunk-jRWAZmH_.js";import{r as t}from"./react-FtSvzJ4N.js";import{a as n}from"./chunk-RD3KTAHR-zATRA5tJ.js";import{l as r,p as i}from"./blocks-CvL71tRc.js";import{t as a}from"./mdx-react-shim-DJpA_GAc.js";import{n as o,t as s}from"./atomic-doc-template-BrmV5DRP.js";import c,{Default as l,t as u}from"./atomic-smart-snippet.new.stories-B8_dVCeS.js";function d(e){let n={code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...t(),...e.components};return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(r,{of:c}),`
`,(0,p.jsxs)(s,{stories:{Default:l},githubPath:`search/atomic-smart-snippet/atomic-smart-snippet/atomic-smart-snippet.ts`,tagName:`atomic-smart-snippet`,className:`AtomicSmartSnippet`,children:[(0,p.jsxs)(n.p,{children:[`The `,(0,p.jsx)(n.code,{children:`atomic-smart-snippet`}),` component displays the excerpt of a document that would be most likely to answer a particular query. It provides users with quick answers directly in the search results.`]}),(0,p.jsxs)(n.p,{children:[`This component is used within the `,(0,p.jsx)(n.code,{children:`atomic-search-interface`}),`:`]}),(0,p.jsx)(n.pre,{children:(0,p.jsx)(n.code,{className:`language-html`,children:`<atomic-search-interface>
...
`]}),(0,p.jsx)(n.h2,{id:`basic-usage`,children:`Basic Usage`}),(0,p.jsx)(n.p,{children:`To add a smart snippet to your interface:`}),(0,p.jsx)(n.pre,{children:(0,p.jsx)(n.code,{className:`language-html`,children:`<atomic-smart-snippet></atomic-smart-snippet>
`})}),(0,p.jsx)(n.h2,{id:`customization`,children:`Customization`}),(0,p.jsx)(n.h3,{id:`heading-level`,children:`Heading Level`}),(0,p.jsx)(n.p,{children:`Set the heading level for the question (from 1 to 5):`}),(0,p.jsx)(n.pre,{children:(0,p.jsx)(n.code,{className:`language-html`,children:`<atomic-smart-snippet heading-level="2"></atomic-smart-snippet>
`})}),(0,p.jsx)(n.h3,{id:`height-configuration`,children:`Height Configuration`}),(0,p.jsx)(n.p,{children:`Control when the "show more/less" buttons appear:`}),(0,p.jsx)(n.pre,{children:(0,p.jsx)(n.code,{className:`language-html`,children:`<atomic-smart-snippet
  maximum-height="250"
...
`]}),(0,p.jsx)(n.h3,{id:`custom-styling`,children:`Custom Styling`}),(0,p.jsx)(n.p,{children:`You can style the snippet content using a template element:`}),(0,p.jsx)(n.pre,{children:(0,p.jsx)(n.code,{className:`language-html`,children:`<atomic-smart-snippet>
  <template>
    <style>
      b {
        color: blue;
...
`})}),(0,p.jsxs)(n.p,{children:[`Or use the `,(0,p.jsx)(n.code,{children:`snippet-style`}),` attribute:`]}),(0,p.jsx)(n.pre,{children:(0,p.jsx)(n.code,{className:`language-html`,children:`<atomic-smart-snippet snippet-style="b { color: blue; }"></atomic-smart-snippet>
`})}),(0,p.jsx)(n.h3,{id:`tab-filtering`,children:`Tab Filtering`}),(0,p.jsx)(n.p,{children:`Display the smart snippet only on specific tabs:`}),(0,p.jsx)(n.pre,{children:(0,p.jsx)(n.code,{className:`language-html`,children:`<!-- Show only on specific tabs -->
...
`})}),(0,p.jsxs)(n.p,{children:[(0,p.jsx)(n.strong,{children:`Note`}),`: Don't use both `,(0,p.jsx)(n.code,{children:`tabs-included`}),` and `,(0,p.jsx)(n.code,{children:`tabs-excluded`}),` at the same time.`]}),(0,p.jsx)(n.h3,{id:`source-link-attributes`,children:`Source Link Attributes`}),(0,p.jsx)(n.p,{children:`Pass custom attributes to the source links using slots:`}),(0,p.jsx)(n.pre,{children:(0,p.jsx)(n.code,{className:`language-html`,children:`<atomic-smart-snippet>
