import{n as e}from"./chunk-jRWAZmH_.js";import{D as t,E as n,St as r,Tt as i}from"./iframe-cSkD6HDI.js";import{n as a,t as o}from"./common-meta-parameters-BmIbTEf7.js";import{n as s,t as c}from"./mock-CijMLWxR.js";import{n as l,t as u}from"./insight-interface-wrapper-BwybnAhf.js";var d,f,p,m,h,g,_,v,y,b,x=e((()=>{t(),r(),s(),o(),u(),{decorator:d,play:f}=l(),{events:p,args:m,argTypes:h,template:g}=n(`atomic-insight-interface`,{excludeCategories:[`methods`]}),_=new c,_.searchEndpoint.mock(e=>({...e,results:e.results.map(e=>({...e,isTopResult:!1,isRecommendation:!1,raw:{...e.raw,sourcetype:`YouTube`,syssourcetype:`YouTube`,ytchanneltitle:`Coveo Support Channel`,ytviewcount:1234}}))})),v={component:`atomic-insight-interface`,title:`Insight/Interface`,id:`atomic-insight-interface`,render:e=>g(e),decorators:[d],parameters:{...a,chromatic:{disableSnapshot:!0},actions:{handles:p},msw:{handlers:[..._.handlers]}},beforeEach:()=>{_.searchEndpoint.clear(),_.querySuggestEndpoint.clear()},args:m,argTypes:h,play:f},y={decorators:[()=>i`<atomic-insight-layout>
        <style>
      ...
      </atomic-insight-layout>`],play:async e=>{await f(e)}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  decorators: [() => html\`<atomic-insight-layout>
        <style>
          atomic-insight-search-box {
            position: relative;
          }
