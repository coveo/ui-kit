import{n as e}from"./chunk-jRWAZmH_.js";import{St as t,Tt as n}from"./iframe-cSkD6HDI.js";import{n as r,t as i}from"./is-test-mode-CTyrSANe.js";import{n as a,t as o}from"./common-meta-parameters-BmIbTEf7.js";import{i as s,n as c,o as l,t as u}from"./mock-CijMLWxR.js";import{getSampleInsightEngineConfiguration as d}from"/headless/v3.50.1/insight/headless.esm.js";async function f(e){await customElements.whenDefined(`atomic-insight-interface`),await e.querySelector(`atomic-insight-interface`).initialize(d())}var p,m,h,g;e((()=>{t(),c(),s(),o(),i(),p=new u,m={component:`insight-page`,title:`Insight/Example Pages`,id:`insight-page`,parameters:{...a,layout:`fullscreen`,msw:{handlers:[...p.handlers]},chromatic:{disableSnapshot:!1}},beforeEach:async()=>{p.searchEndpoint.mock(()=>l)},render:()=>n`
    <style>
  ...
  `,play:async e=>{await f(e.canvasElement),await e.canvasElement.querySelector(`atomic-insight-interface`).executeFirstSearch()}},h={name:`Insight Page`},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  name: 'Insight Page'
