import{n as e}from"./chunk-jRWAZmH_.js";import{St as t,Tt as n}from"./iframe-cSkD6HDI.js";import{n as r,t as i}from"./is-test-mode-CTyrSANe.js";import{n as a,t as o}from"./common-meta-parameters-BmIbTEf7.js";import{i as s,n as c,o as l,t as u}from"./mock-C5ckzz_b.js";import{getSampleSearchEngineConfiguration as d}from"/headless/v3.50.1/headless.esm.js";async function f(e){await customElements.whenDefined(`atomic-search-interface`),await e.querySelector(`atomic-search-interface`).initialize(d())}var p,m,h,g;e((()=>{t(),c(),s(),o(),i(),p=new u,m={component:`ipx-page`,title:`IPX/Example Pages`,id:`ipx-page`,parameters:{...a,layout:`fullscreen`,msw:{handlers:[...p.handlers]},chromatic:{disableSnapshot:!1}},beforeEach:async()=>{p.searchEndpoint.mock(()=>l)},render:()=>n`
    <style>
      .search-section {
        width: 100%;
        display: flex;
  ...
  `,play:async e=>{await f(e.canvasElement),await e.canvasElement.querySelector(`atomic-search-interface`).executeFirstSearch();let t=e.canvasElement.querySelector(`atomic-ipx-button`);if(t){let e=t.shadowRoot;if(e){let t=e.querySelector(`button`);t&&t.click()}}}},h={name:`IPX Modal Page`},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  name: 'IPX Modal Page'
