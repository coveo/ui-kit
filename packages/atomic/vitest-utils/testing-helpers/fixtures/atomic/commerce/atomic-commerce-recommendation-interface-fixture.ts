...
import type {
  ...
  CommerceBindings,
} from '@/src/components/commerce/atomic-commerce-recommendation-interface/atomic-commerce-recommendation-interface.js';
...
export const defaultBindings = {
  interfaceElement: {} as AtomicCommerceRecommendationInterface,
  store: {
    state: {
