  ...
  results: [
    {
      ...
      excerpt: 'Collection of support articles',
      clickUri: 'https://support.example.com/kb',
      printableUri: 'https://support.example.com/kb',
      uri: 'support://kb',
      uniqueId: 'kb-parent',
      ...
      childResults: [
        {
          ...
          excerpt: 'How to troubleshoot network connectivity problems',
          clickUri: 'https://support.example.com/kb/network',
          uniqueId: 'kb-network-child',
          raw: {
            foldingcollection: 'Knowledge Base',
            foldingchild: ['network'],
            foldingparent: 'kb',
          },
        },
        {
          title: 'System Performance Tips',
          excerpt: 'Best practices for optimizing system performance',
          clickUri: 'https://support.example.com/kb/performance',
          uniqueId: 'kb-performance-child',
          raw: {
            foldingcollection: 'Knowledge Base',
            foldingchild: ['performance'],
            foldingparent: 'kb',
          },
        },
      ],
      absentTerms: [],
      raw: {
        systitle: 'Knowledge Base Articles',
        sysdescription: 'Collection of support articles',
        sysuri: 'https://support.example.com/kb',
        sysauthor: ['Support Team'],
        sysurihash: 'kb-hash',
        urihash: 'kb-hash',
        permanentid: 'kb-perm-id',
        syslanguage: ['English'],
        date: Date.now(),
        sourcetype: 'KnowledgeBase',
        syssource: 'Support Knowledge Base',
