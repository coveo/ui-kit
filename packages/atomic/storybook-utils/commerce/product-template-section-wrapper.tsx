  ...
  const decorator: Decorator = (story) => {
    ...
    const allSections = [
      {
        ...
        content: `<h3 class="text-lg font-semibold text-gray-900">Sony WH-1000XM4 Wireless Headphones</h3>`,
      },
      {
    ...
    `,
      },
      {
        ...
        content: `<img src="https://images.barca.group/Sports/mj/Clothing/Pants/67_Men_Gray_Elastane/cb1a7d3c9ac3_bottom_left.webp" alt="Product Image" class="w-full h-auto rounded-lg">`,
      },
      {
        tag: 'atomic-product-section-metadata',
        content: `<span class="text-sm text-gray-500">SKU: WH-1000XM4</span>`,
      },
      {
        tag: 'atomic-product-section-emphasized',
        content: `<span class="text-2xl font-bold text-green-600">$299.99</span>`,
      },
      {
        tag: 'atomic-product-section-description',
        content: `<p class="text-sm text-gray-600">Premium wireless headphones with industry-leading noise cancellation and superior sound quality.</p>`,
      },
      {
        tag: 'atomic-product-section-actions',
        content: `<button class="p-1 btn btn-primary">Add to Cart</button>`,
      },
      {
