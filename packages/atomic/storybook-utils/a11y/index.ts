...
export {COVERED_CRITERIA as COMBOBOX_COVERED_CRITERIA, testComboboxA11y} from './combobox.js';
export {
  COVERED_CRITERIA as DIALOG_COVERED_CRITERIA,
  testDialogA11y,
  type DialogA11yOptions,
} from './dialog.js';
export {COVERED_CRITERIA as TABS_COVERED_CRITERIA, testTabsA11y} from './tabs.js';
export {
