    ...
    const allSections = [
      {
        ...
        content: `<h3 class="text-lg font-semibold text-gray-900">Palm cockatoo: Why a unique ‘drumming’ bird is in peril - BBC News</h3>`,
      },
      {
        tag: 'atomic-result-section-children',
        content: `<div class="p-3 mt-2 ml-4 border border-gray-200 rounded-lg bg-gray-50">
      ...
      },
      {
        ...
        content: `<img src="https://picsum.photos/seed/picsum/200" alt="Result Image" class="w-full h-auto rounded-lg">`,
      },
      {
        tag: 'atomic-result-section-title-metadata',
        content: `<span class="text-sm text-gray-500">fileType:
txt</span>`,
      },
      {
        tag: 'atomic-result-section-emphasized',
        content: `<span class="text-2xl font-bold">Breaking News!</span>`,
      },
      {
        tag: 'atomic-result-section-excerpt',
        content: `<p class="text-sm text-gray-600">The palm cockatoo is thought to be the only bird species to use tools musically – drumming wood to attract a mate.</p>`,
      },
      {
