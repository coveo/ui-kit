...
export namespace Components {
     ...
     * Unlike regular facets that need to be explicitly defined and requested in the query,
     ...
     * the automatic facets feature. Unlike regular facets that need to be explicitly defined
     * and requested in the query, automatic facets are dynamically generated by the index
     * in response to the search query.
     * **Note:** This component renders multiple `atomic-automatic-facet` based on the desiredCount property.
     * To learn more about the automatic facet generator feature, see: [About the Facet Generator](https://docs.coveo.com/en/n9sd0159/).
     */
