...
import {
  ...
  InteractiveResult,
  LogLevel,
  PlatformEnvironment as PlatformEnvironment1,
...
import {
  ...
  ResultDisplayLayout,
  ResultTarget,
} from './components/common/layout/display-options';
...
export namespace Components {
   ...
   * Unlike traditional facets that need to be explicitly defined and requested in the search query, automatic facets are dynamically generated by the index
   * in response to the search query.
   * It's important to note that this component is not typically used directly.
   * It is internally used by the `atomic-automatic-facet-generator` component to automatically render updated facets.
   * To read more about the automatic facet generator feature, see: https://docs.coveo.com/en/3383#about-the-facet-generator-feature
   */
  ...
  interface AtomicInsightInterface {
    ...
    getOrganizationEndpoints: (
      ...
      env?: PlatformEnvironmentInsight
    ) => Promise<{
      platform: string;
      analytics: string;
      search: string;
...
export interface AtomicInsightSmartSnippetFeedbackModalCustomEvent<T>
...
export interface AtomicSmartSnippetExpandableAnswerCustomEvent<T>
  extends CustomEvent<T> {
  detail: T;
  target: HTMLAtomicSmartSnippetExpandableAnswerElement;
}
export interface AtomicSmartSnippetFeedbackModalCustomEvent<T>
  extends CustomEvent<T> {
  detail: T;
...
declare global {
   ...
   * The `atomic-aria-live` component notifies screen readers of changes in the search interface.
   */
  interface HTMLAtomicAriaLiveElement
    extends Components.AtomicAriaLive,
      HTMLStencilElement {}
   ...
   * To read more about the automatic facet generator feature, see: https://docs.coveo.com/en/3383#about-the-facet-generator-feature
   */
  interface HTMLAtomicAutomaticFacetElement
    extends Components.AtomicAutomaticFacet,
      HTMLStencilElement {}
   ...
   * To read more about the automatic facet generator feature, see: https://docs.coveo.com/en/3383#about-the-facet-generator-feature
   */
  interface HTMLAtomicAutomaticFacetGeneratorElement
    extends Components.AtomicAutomaticFacetGenerator,
      HTMLStencilElement {}
   ...
   * The `atomic-breadbox` component creates breadcrumbs that display a summary of the currently active facet values.
   */
  interface HTMLAtomicBreadboxElement
    extends Components.AtomicBreadbox,
      HTMLStencilElement {}
   ...
   * An `atomic-color-facet` displays a facet of the results for the current query as colors.
   */
  interface HTMLAtomicColorFacetElement
    extends Components.AtomicColorFacet,
      HTMLStencilElement {}
   ...
   * The `atomic-external` component allows components defined outside of the `atomic-search-interface` to initialize.
   */
  interface HTMLAtomicExternalElement
    extends Components.AtomicExternal,
      HTMLStencilElement {}
   ...
   * Internal component made to be integrated in a TimeframeFacet.
   */
  interface HTMLAtomicFacetDateInputElement
    extends Components.AtomicFacetDateInput,
      HTMLStencilElement {}
   ...
   * Internal component made to be integrated in a NumericFacet.
   */
  interface HTMLAtomicFacetNumberInputElement
    extends Components.AtomicFacetNumberInput,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicFocusDetectorElement
    extends Components.AtomicFocusDetector,
      HTMLStencilElement {}
  var HTMLAtomicFocusDetectorElement: {
    prototype: HTMLAtomicFocusDetectorElement;
    new (): HTMLAtomicFocusDetectorElement;
  };
  interface HTMLAtomicFocusTrapElement
    extends Components.AtomicFocusTrap,
      HTMLStencilElement {}
   ...
   * The `atomic-folded-result-list` component is responsible for displaying folded query results, by applying one or more result templates for up to three layers (i.e., to the result, child and grandchild).
   */
  interface HTMLAtomicFoldedResultListElement
    extends Components.AtomicFoldedResultList,
      HTMLStencilElement {}
   ...
   * The numerical format of compatible parents will be set according to the currency property of this component.
   */
  interface HTMLAtomicFormatCurrencyElement
    extends Components.AtomicFormatCurrency,
      HTMLStencilElement {}
   ...
   * The numerical format of compatible parents will be set according to the properties of this component.
   */
  interface HTMLAtomicFormatNumberElement
   ...
   * The numerical format of compatible parents will be set according to the properties of this component.
   */
  interface HTMLAtomicFormatUnitElement
    extends Components.AtomicFormatUnit,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicGeneratedAnswerElement
    extends Components.AtomicGeneratedAnswer,
      HTMLStencilElement {}
   ...
   * Use only with values for which you are certain the content is harmless.
   */
  interface HTMLAtomicHtmlElement
    extends Components.AtomicHtml,
      HTMLStencilElement {}
   ...
   * This component can display an icon from those available in the Atomic package, from a specific location, or as an inline SVG element.
   */
  interface HTMLAtomicIconElement
    extends Components.AtomicIcon,
      HTMLStencilElement {}
  var HTMLAtomicIconElement: {
    prototype: HTMLAtomicIconElement;
    new (): HTMLAtomicIconElement;
  };
  interface HTMLAtomicInsightEditToggleElement
    extends Components.AtomicInsightEditToggle,
      HTMLStencilElement {}
  var HTMLAtomicInsightEditToggleElement: {
    prototype: HTMLAtomicInsightEditToggleElement;
    new (): HTMLAtomicInsightEditToggleElement;
  };
  interface HTMLAtomicInsightFacetElement
    extends Components.AtomicInsightFacet,
      HTMLStencilElement {}
  var HTMLAtomicInsightFacetElement: {
    prototype: HTMLAtomicInsightFacetElement;
    new (): HTMLAtomicInsightFacetElement;
  };
  interface HTMLAtomicInsightFoldedResultListElement
    extends Components.AtomicInsightFoldedResultList,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightFullSearchButtonElement
    extends Components.AtomicInsightFullSearchButton,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightHistoryToggleElement
    extends Components.AtomicInsightHistoryToggle,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightPagerElement
    extends Components.AtomicInsightPager,
      HTMLStencilElement {}
  var HTMLAtomicInsightPagerElement: {
    prototype: HTMLAtomicInsightPagerElement;
    new (): HTMLAtomicInsightPagerElement;
  };
  interface HTMLAtomicInsightQueryErrorElement
    extends Components.AtomicInsightQueryError,
      HTMLStencilElement {}
  var HTMLAtomicInsightQueryErrorElement: {
    prototype: HTMLAtomicInsightQueryErrorElement;
    new (): HTMLAtomicInsightQueryErrorElement;
  };
  interface HTMLAtomicInsightQuerySummaryElement
    extends Components.AtomicInsightQuerySummary,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightRefineModalElement
    extends Components.AtomicInsightRefineModal,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightRefineToggleElement
    extends Components.AtomicInsightRefineToggle,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightResultElement
    extends Components.AtomicInsightResult,
      HTMLStencilElement {}
  var HTMLAtomicInsightResultElement: {
    prototype: HTMLAtomicInsightResultElement;
    new (): HTMLAtomicInsightResultElement;
  };
  interface HTMLAtomicInsightResultActionElement
    extends Components.AtomicInsightResultAction,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightResultActionBarElement
    extends Components.AtomicInsightResultActionBar,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightResultChildrenElement
    extends Components.AtomicInsightResultChildren,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightResultChildrenTemplateElement
    extends Components.AtomicInsightResultChildrenTemplate,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightResultListElement
    extends Components.AtomicInsightResultList,
      HTMLStencilElement {}
  var HTMLAtomicInsightResultListElement: {
    prototype: HTMLAtomicInsightResultListElement;
    new (): HTMLAtomicInsightResultListElement;
  };
  interface HTMLAtomicInsightResultTemplateElement
    extends Components.AtomicInsightResultTemplate,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightSearchBoxElement
    extends Components.AtomicInsightSearchBox,
      HTMLStencilElement {}
  var HTMLAtomicInsightSearchBoxElement: {
    prototype: HTMLAtomicInsightSearchBoxElement;
    new (): HTMLAtomicInsightSearchBoxElement;
  };
  interface HTMLAtomicInsightSmartSnippetElement
    extends Components.AtomicInsightSmartSnippet,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightSmartSnippetFeedbackModalElement
    extends Components.AtomicInsightSmartSnippetFeedbackModal,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightSmartSnippetSuggestionsElement
    extends Components.AtomicInsightSmartSnippetSuggestions,
      HTMLStencilElement {}
  ...
  interface HTMLAtomicInsightTabElement
    extends Components.AtomicInsightTab,
      HTMLStencilElement {}
  var HTMLAtomicInsightTabElement: {
    prototype: HTMLAtomicInsightTabElement;
    new (): HTMLAtomicInsightTabElement;
  };
  interface HTMLAtomicInsightTabsElement
    extends Components.AtomicInsightTabs,
      HTMLStencilElement {}
  var HTMLAtomicInsightTabsElement: {
    prototype: HTMLAtomicInsightTabsElement;
    new (): HTMLAtomicInsightTabsElement;
  };
  interface HTMLAtomicInsightTimeframeFacetElement
    extends Components.AtomicInsightTimeframeFacet,
      HTMLStencilElement {}
   ...
   * The `atomic-layout-section` lets you identify various sections for the related `atomic-layout` component.
   */
  interface HTMLAtomicLayoutSectionElement
    extends Components.AtomicLayoutSection,
      HTMLStencilElement {}
   ...
   * The `atomic-load-more-children-results` component allows to load the full collection for a folded result.
   */
  interface HTMLAtomicLoadMoreChildrenResultsElement
    extends Components.AtomicLoadMoreChildrenResults,
      HTMLStencilElement {}
   ...
   * The `atomic-load-more-results` component allows the user to load additional results if more are available.
   */
  interface HTMLAtomicLoadMoreResultsElement
    extends Components.AtomicLoadMoreResults,
      HTMLStencilElement {}
   ...
   * When the modal is opened, the class `atomic-modal-opened` is added to the interfaceElement and the body, allowing further customization.
   */
  interface HTMLAtomicModalElement
    extends Components.AtomicModal,
      HTMLStencilElement {}
   ...
   * The `atomic-notifications` component is responsible for displaying notifications generated by the Coveo Search API (see [Trigger](https://docs.coveo.com/en/1458)).
   */
  interface HTMLAtomicNotificationsElement
    extends Components.AtomicNotifications,
      HTMLStencilElement {}
   ...
   * The `atomic-popover` component displays any facet as a popover menu.
   */
  interface HTMLAtomicPopoverElement
    extends Components.AtomicPopover,
      HTMLStencilElement {}
   ...
   * images/links may not work as expected in an `atomic-quickview`).
   */
  interface HTMLAtomicQuickviewElement
    extends Components.AtomicQuickview,
      HTMLStencilElement {}
  var HTMLAtomicQuickviewElement: {
    prototype: HTMLAtomicQuickviewElement;
    new (): HTMLAtomicQuickviewElement;
  };
  interface HTMLAtomicQuickviewModalElement
    extends Components.AtomicQuickviewModal,
      HTMLStencilElement {}
   ...
   * It only supports numeric fields.
   */
  interface HTMLAtomicRatingFacetElement
    extends Components.AtomicRatingFacet,
      HTMLStencilElement {}
   ...
   * It only supports numeric fields.
   */
  interface HTMLAtomicRatingRangeFacetElement
    extends Components.AtomicRatingRangeFacet,
      HTMLStencilElement {}
   ...
   * The `atomic-recs-error` component handles fatal errors when performing a recommendations request on the index or Search API. When the error is known, it displays a link to relevant documentation link for debugging purposes. When the error is unknown, it displays a small text area with the JSON content of the error.
   */
  interface HTMLAtomicRecsErrorElement
    extends Components.AtomicRecsError,
      HTMLStencilElement {}
   ...
   * The `atomic-recs-interface` component is the parent to all other atomic components in a recommendation interface. It handles the headless recommendation engine and localization configurations.
   */
  interface HTMLAtomicRecsInterfaceElement
    extends Components.AtomicRecsInterface,
      HTMLStencilElement {}
   ...
   * The `atomic-recs-list` component displays recommendations by applying one or more result templates.
   */
  interface HTMLAtomicRecsListElement
    extends Components.AtomicRecsList,
      HTMLStencilElement {}
   ...
   * The `atomic-recs-result` component is used internally by the `atomic-recs-list` component.
   */
  interface HTMLAtomicRecsResultElement
    extends Components.AtomicRecsResult,
      HTMLStencilElement {}
   ...
   * @MapProp name: mustNotMatch;attr: must-not-match;docs: The field and values that define which result items the condition must not be applied to. For example, a template with the following attribute only applies to result items whose `filetype` is not `lithiummessage`: `must-not-match-filetype="lithiummessage";type: Record<string, string[]> ;default: {}
   */
  interface HTMLAtomicRecsResultTemplateElement
    extends Components.AtomicRecsResultTemplate,
      HTMLStencilElement {}
   ...
   * When the modal is opened, the class `atomic-modal-opened` is added to the interface element and the body, allowing further customization.
   */
  interface HTMLAtomicRefineModalElement
    extends Components.AtomicRefineModal,
      HTMLStencilElement {}
   ...
   * When this component is added to the `atomic-search-interface`, an `atomic-refine-modal` component is automatically created.
   */
  interface HTMLAtomicRefineToggleElement
    extends Components.AtomicRefineToggle,
      HTMLStencilElement {}
   ...
   * ```
   */
  interface HTMLAtomicResultBadgeElement
    extends Components.AtomicResultBadge,
      HTMLStencilElement {}
   ...
   * only when children exist.
   */
  interface HTMLAtomicResultChildrenElement
    extends Components.AtomicResultChildren,
      HTMLStencilElement {}
   ...
   * @MapProp name: mustNotMatch;attr: must-not-match;docs: The field and values that define which result items the condition must not be applied to. For example, a template with the following attribute only applies to result items whose `filetype` is not `lithiummessage`: `must-not-match-filetype="lithiummessage";type: Record<string, string[]> ;default: {}
   */
  interface HTMLAtomicResultChildrenTemplateElement
    extends Components.AtomicResultChildrenTemplate,
      HTMLStencilElement {}
   ...
   * The `atomic-result-date` component renders the value of a date result field.
   */
  interface HTMLAtomicResultDateElement
    extends Components.AtomicResultDate,
      HTMLStencilElement {}
   ...
   * The `atomic-result-fields-list` component selectively renders its children to ensure they fit the parent element and adds dividers between them.
   */
  interface HTMLAtomicResultFieldsListElement
    extends Components.AtomicResultFieldsList,
      HTMLStencilElement {}
   ...
   * Use only with fields for which you are certain the data is harmless.
   */
  interface HTMLAtomicResultHtmlElement
    extends Components.AtomicResultHtml,
      HTMLStencilElement {}
   ...
   * The component searches for a suitable icon, or outputs a generic icon if the search is unsuccessful.
   */
  interface HTMLAtomicResultIconElement
    extends Components.AtomicResultIcon,
      HTMLStencilElement {}
   ...
   * The `atomic-result-image` component renders an image from a result field.
   */
  interface HTMLAtomicResultImageElement
    extends Components.AtomicResultImage,
      HTMLStencilElement {}
   ...
   * @MapProp name: field;attr: field;docs: The field from which to extract the target string and the variable used to map it to the target i18n parameter. For example, the following configuration extracts the value of `author` from a result, and assign it to the i18n parameter `name`: `field-author="name"`;type: Record<string, string> ;default: {}
   */
  interface HTMLAtomicResultLocalizedTextElement
    extends Components.AtomicResultLocalizedText,
      HTMLStencilElement {}
   ...
   * The `atomic-result-multi-value-text` component renders the values of a multi-value string field.
   */
  interface HTMLAtomicResultMultiValueTextElement
    extends Components.AtomicResultMultiValueText,
      HTMLStencilElement {}
   ...
   * The number can be formatted by adding a `atomic-format-number`, `atomic-format-currency` or `atomic-format-unit` component into this component.
   */
  interface HTMLAtomicResultNumberElement
    extends Components.AtomicResultNumber,
      HTMLStencilElement {}
   ...
   * The `atomic-result-placeholder` component provides an intermediate visual state that is rendered before the first results are available.
   */
  interface HTMLAtomicResultPlaceholderElement
    extends Components.AtomicResultPlaceholder,
      HTMLStencilElement {}
   ...
   * The `atomic-result-rating` element renders a star rating.
   */
  interface HTMLAtomicResultRatingElement
    extends Components.AtomicResultRating,
      HTMLStencilElement {}
   ...
   * * May appear over, next to, or beneath the visual section.
   */
  interface HTMLAtomicResultSectionActionsElement
    extends Components.AtomicResultSectionActions,
      HTMLStencilElement {}
   ...
   * * May appear over, next to, or beneath the visual section.
   */
  interface HTMLAtomicResultSectionBadgesElement
    extends Components.AtomicResultSectionBadges,
      HTMLStencilElement {}
   ...
   * * Has a font weight.
   */
  interface HTMLAtomicResultSectionBottomMetadataElement
    extends Components.AtomicResultSectionBottomMetadata,
      HTMLStencilElement {}
   ...
   * * Shows children at the bottom of the result, indented and wrapped in a border.
   */
  interface HTMLAtomicResultSectionChildrenElement
    extends Components.AtomicResultSectionChildren,
      HTMLStencilElement {}
   ...
   * * Is the second closest element beneath the title section.
   */
  interface HTMLAtomicResultSectionEmphasizedElement
    extends Components.AtomicResultSectionEmphasized,
      HTMLStencilElement {}
   ...
   * * Has a defined CSS `color` property for text.
   */
  interface HTMLAtomicResultSectionExcerptElement
    extends Components.AtomicResultSectionExcerpt,
      HTMLStencilElement {}
   ...
   * * Has a defined CSS `color` property for text.
   */
  interface HTMLAtomicResultSectionTitleElement
    extends Components.AtomicResultSectionTitle,
      HTMLStencilElement {}
   ...
   * * Is the closest element beneath the title section.
   */
  interface HTMLAtomicResultSectionTitleMetadataElement
    extends Components.AtomicResultSectionTitleMetadata,
      HTMLStencilElement {}
   ...
   * * Always has a 1:1 aspect ratio.
   */
  interface HTMLAtomicResultSectionVisualElement
    extends Components.AtomicResultSectionVisual,
      HTMLStencilElement {}
   ...
   * The `atomic-result-table-placeholder` component provides an intermediate visual state that is rendered before the first results are available.
   */
  interface HTMLAtomicResultTablePlaceholderElement
    extends Components.AtomicResultTablePlaceholder,
      HTMLStencilElement {}
   ...
   * The `atomic-result-text` component renders the value of a string result field.
   */
  interface HTMLAtomicResultTextElement
    extends Components.AtomicResultText,
      HTMLStencilElement {}
   ...
   * The `atomic-result-timespan` component renders a target result number field value as a duration.
   */
  interface HTMLAtomicResultTimespanElement
    extends Components.AtomicResultTimespan,
      HTMLStencilElement {}
   ...
   * This component does not support accessibility out-of-the-box. To do so, see [Instant Results Accessibility](https://docs.coveo.com/en/atomic/latest/usage/accessibility/#instant-results-accessibility).
   */
  interface HTMLAtomicSearchBoxInstantResultsElement
    extends Components.AtomicSearchBoxInstantResults,
      HTMLStencilElement {}
   ...
   * The `atomic-search-box-query-suggestions` component can be added as a child of an `atomic-search-box` component, allowing for the configuration of query suggestion behavior.
   */
  interface HTMLAtomicSearchBoxQuerySuggestionsElement
    extends Components.AtomicSearchBoxQuerySuggestions,
      HTMLStencilElement {}
   ...
   * The `atomic-search-box-recent-queries` component can be added as a child of an `atomic-search-box` component, allowing for the configuration of recent query suggestions.
   */
  interface HTMLAtomicSearchBoxRecentQueriesElement
   ...
   * The `atomic-search-layout` helps organize elements in the page.
   */
  interface HTMLAtomicSearchLayoutElement
    extends Components.AtomicSearchLayout,
      HTMLStencilElement {}
   ...
   * The `atomic-segmented-facet` displays a horizontal facet of the results for the current query.
   */
  interface HTMLAtomicSegmentedFacetElement
    extends Components.AtomicSegmentedFacet,
      HTMLStencilElement {}
   ...
   * The 'atomic-segmented-facet-scrollable' component wraps around one or several 'atomic-segmented-facet' to provide horizontal scrolling capabilities.
   */
  interface HTMLAtomicSegmentedFacetScrollableElement
    extends Components.AtomicSegmentedFacetScrollable,
      HTMLStencilElement {}
   ...
   * ```
   */
  interface HTMLAtomicSmartSnippetElement
    extends Components.AtomicSmartSnippet,
      HTMLStencilElement {}
  var HTMLAtomicSmartSnippetElement: {
    prototype: HTMLAtomicSmartSnippetElement;
    new (): HTMLAtomicSmartSnippetElement;
  };
  interface HTMLAtomicSmartSnippetAnswerElement
  ...
  interface HTMLAtomicSmartSnippetCollapseWrapperElement
  ...
  interface HTMLAtomicSmartSnippetExpandableAnswerElement
    extends Components.AtomicSmartSnippetExpandableAnswer,
      HTMLStencilElement {}
   ...
   * When the modal is opened, the class `atomic-modal-opened` is added to the body, allowing further customization.
   */
  interface HTMLAtomicSmartSnippetFeedbackModalElement
  ...
  interface HTMLAtomicSmartSnippetSourceElement
    extends Components.AtomicSmartSnippetSource,
      HTMLStencilElement {}
   ...
   * ```
   */
  interface HTMLAtomicSmartSnippetSuggestionsElement
    extends Components.AtomicSmartSnippetSuggestions,
      HTMLStencilElement {}
   ...
   * The `atomic-sort-expression` component defines a sort expression. This component must be inside an `atomic-sort-dropdown` component.
   */
  interface HTMLAtomicSortExpressionElement
    extends Components.AtomicSortExpression,
      HTMLStencilElement {}
   ...
   * The `atomic-table-element` element defines a table column in a result list.
   */
  interface HTMLAtomicTableElementElement
    extends Components.AtomicTableElement,
      HTMLStencilElement {}
   ...
   * A timeframe is a span of time from now to a specific time in the past.
   */
  interface HTMLAtomicTimeframeElement
    extends Components.AtomicTimeframe,
      HTMLStencilElement {}
   ...
   * An `atomic-timeframe-facet` displays a facet of the results for the current query as date intervals.
   */
  interface HTMLAtomicTimeframeFacetElement
    extends Components.AtomicTimeframeFacet,
      HTMLStencilElement {}
  ...
  interface HTMLTabPopoverElement
    extends Components.TabPopover,
      HTMLStencilElement {}
...
declare namespace LocalJSX {
  ...
  interface AtomicFacetDateInput {
    ...
    max?: string;
    min?: string;
    'onAtomic/dateInputApply'?: (
      event: AtomicFacetDateInputCustomEvent<any>
    ) => void;
  }
  /**
   * The `atomic-facet-manager` helps reorder facets and their values to match the most recent search response with the most relevant results. A facet component is slotted within an `atomic-facet-manager` to leverage this functionality.
  ...
  interface AtomicFacetNumberInput {
    ...
    filterState: NumericFilterState;
    label: string;
    'onAtomic/numberInputApply'?: (
      event: AtomicFacetNumberInputCustomEvent<any>
    ) => void;
    type: NumberInputType;
  }
  /**
  ...
  interface AtomicInsightPager {
     ...
     */
    numberOfPages?: number;
    'onAtomic/scrollToTop'?: (
      event: AtomicInsightPagerCustomEvent<any>
    ) => void;
  }
  interface AtomicInsightQueryError {}
  interface AtomicInsightQuerySummary {}
  ...
  interface AtomicInsightSmartSnippetFeedbackModal {
    isOpen?: boolean;
    onFeedbackSent?: (
      event: AtomicInsightSmartSnippetFeedbackModalCustomEvent<any>
    ) => void;
    source?: HTMLElement;
  }
  interface AtomicInsightSmartSnippetSuggestions {
  ...
  interface AtomicQuickviewModal {
    ...
    current?: number;
    modalCloseCallback?: () => void;
    'onAtomic/quickview/next'?: (
      event: AtomicQuickviewModalCustomEvent<any>
    ) => void;
    'onAtomic/quickview/previous'?: (
      event: AtomicQuickviewModalCustomEvent<any>
    ) => void;
    result?: Result;
    sandbox?: string;
  ...
  interface AtomicRelevanceInspector {
     ...
     */
    bindings: Bindings;
    'onAtomic/relevanceInspector/close'?: (
      event: AtomicRelevanceInspectorCustomEvent<any>
    ) => void;
    open?: boolean;
  }
  /**
  ...
  interface AtomicResultsPerPage {
    ...
    initialChoice?: number;
    'onAtomic/scrollToTop'?: (
      event: AtomicResultsPerPageCustomEvent<any>
    ) => void;
  }
  /**
   * The `atomic-search-box` component creates a search box with built-in support for suggestions.
  ...
  interface AtomicSearchBox {
     ...
     */
    onRedirect?: (
      event: AtomicSearchBoxCustomEvent<RedirectionPayload>
    ) => void;
    /**
     * Defining this option makes the search box standalone (see [Use a Standalone Search Box](https://docs.coveo.com/en/atomic/latest/usage/ssb/)).  This option defines the default URL the user should be redirected to, when a query is submitted. If a query pipeline redirect is triggered, it will redirect to that URL instead (see [query pipeline triggers](https://docs.coveo.com/en/1458)).
     */
  ...
  interface AtomicSmartSnippetAnswer {
    ...
    innerStyle?: string;
    onAnswerSizeUpdated?: (
      event: AtomicSmartSnippetAnswerCustomEvent<{height: number}>
    ) => void;
    onBeginDelayedSelectInlineLink?: (
      event: AtomicSmartSnippetAnswerCustomEvent<InlineLink>
    ) => void;
  ...
  interface AtomicSmartSnippetExpandableAnswer {
    ...
    maximumHeight?: number;
    onBeginDelayedSelectInlineLink?: (
      event: AtomicSmartSnippetExpandableAnswerCustomEvent<InlineLink>
    ) => void;
    onCancelPendingSelectInlineLink?: (
      event: AtomicSmartSnippetExpandableAnswerCustomEvent<InlineLink>
    ) => void;
    onCollapse?: (
      event: AtomicSmartSnippetExpandableAnswerCustomEvent<any>
    ) => void;
    onExpand?: (
      event: AtomicSmartSnippetExpandableAnswerCustomEvent<any>
    ) => void;
  ...
  interface AtomicSmartSnippetFeedbackModal {
    isOpen?: boolean;
    onFeedbackSent?: (
      event: AtomicSmartSnippetFeedbackModalCustomEvent<any>
    ) => void;
    source?: HTMLElement;
  }
  interface AtomicSmartSnippetSource {
    ...
    onBeginDelayedSelectSource?: (
      event: AtomicSmartSnippetSourceCustomEvent<any>
    ) => void;
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
       ...
       * The `atomic-aria-live` component notifies screen readers of changes in the search interface.
       */
      'atomic-aria-live': LocalJSX.AtomicAriaLive &
        JSXBase.HTMLAttributes<HTMLAtomicAriaLiveElement>;
      /**
       * An automatic facet is a special type of facet generated by the automatic facets feature.
       * Unlike traditional facets that need to be explicitly defined and requested in the search query, automatic facets are dynamically generated by the index
       * in response to the search query.
       ...
       * To read more about the automatic facet generator feature, see: https://docs.coveo.com/en/3383#about-the-facet-generator-feature
       */
      'atomic-automatic-facet': LocalJSX.AtomicAutomaticFacet &
        JSXBase.HTMLAttributes<HTMLAtomicAutomaticFacetElement>;
      /**
       * The `atomic-automatic-facet-generator` is a component that renders the facets from
       * the automatic facets feature.
       * Unlike traditional facets that need to be explicitly defined and requested in the search query, automatic facets are dynamically generated by the index
       ...
       * To read more about the automatic facet generator feature, see: https://docs.coveo.com/en/3383#about-the-facet-generator-feature
       */
      'atomic-automatic-facet-generator': LocalJSX.AtomicAutomaticFacetGenerator &
        JSXBase.HTMLAttributes<HTMLAtomicAutomaticFacetGeneratorElement>;
      /**
       * The `atomic-breadbox` component creates breadcrumbs that display a summary of the currently active facet values.
       */
      'atomic-breadbox': LocalJSX.AtomicBreadbox &
        JSXBase.HTMLAttributes<HTMLAtomicBreadboxElement>;
      /**
       * A facet is a list of values for a certain field occurring in the results, ordered using a configurable criteria (e.g., number of occurrences).
       * An `atomic-category-facet` displays a facet of values in a browsable, hierarchical fashion.
       */
       ...
       * An `atomic-color-facet` displays a facet of the results for the current query as colors.
       */
      'atomic-color-facet': LocalJSX.AtomicColorFacet &
        JSXBase.HTMLAttributes<HTMLAtomicColorFacetElement>;
      /**
       * The `atomic-component-error` is used by other components to return errors. This doesn't require any configuration.
       */
       ...
       * The `atomic-external` component allows components defined outside of the `atomic-search-interface` to initialize.
       */
      'atomic-external': LocalJSX.AtomicExternal &
        JSXBase.HTMLAttributes<HTMLAtomicExternalElement>;
      /**
       * A facet is a list of values for a certain field occurring in the results, ordered using a configurable criteria (e.g., number of occurrences).
       * An `atomic-facet` displays a facet of the results for the current query.
       */
       ...
       * Internal component made to be integrated in a TimeframeFacet.
       */
      'atomic-facet-date-input': LocalJSX.AtomicFacetDateInput &
        JSXBase.HTMLAttributes<HTMLAtomicFacetDateInputElement>;
      /**
       * The `atomic-facet-manager` helps reorder facets and their values to match the most recent search response with the most relevant results. A facet component is slotted within an `atomic-facet-manager` to leverage this functionality.
       */
      ...
      'atomic-facet-number-input': LocalJSX.AtomicFacetNumberInput &
        JSXBase.HTMLAttributes<HTMLAtomicFacetNumberInputElement>;
      /**
       * The `atomic-field-condition` component takes a list of conditions that, if fulfilled, apply the template in which it's defined.
       * @MapProp name: mustMatch;attr: must-match;docs: The field and values that define which result items the condition must be applied to. For example, a template with the following attribute only applies to result items whose `filetype` is `lithiummessage` or `YouTubePlaylist`: `must-match-filetype="lithiummessage,YouTubePlaylist"`;type: Record<string, string[]> ;default: {}
       * @MapProp name: mustNotMatch;attr: must-not-match;docs: The field and values that define which result items the condition must not be applied to. For example, a template with the following attribute only applies to result items whose `filetype` is not `lithiummessage`: `must-not-match-filetype="lithiummessage";type: Record<string, string[]> ;default: {}
      ...
      'atomic-focus-detector': LocalJSX.AtomicFocusDetector &
        JSXBase.HTMLAttributes<HTMLAtomicFocusDetectorElement>;
      'atomic-focus-trap': LocalJSX.AtomicFocusTrap &
        JSXBase.HTMLAttributes<HTMLAtomicFocusTrapElement>;
      /**
       * The `atomic-folded-result-list` component is responsible for displaying folded query results, by applying one or more result templates for up to three layers (i.e., to the result, child and grandchild).
       */
      'atomic-folded-result-list': LocalJSX.AtomicFoldedResultList &
        JSXBase.HTMLAttributes<HTMLAtomicFoldedResultListElement>;
      /**
       * The `atomic-format-currency` component is used for formatting currencies.
       * The numerical format of compatible parents will be set according to the currency property of this component.
       */
      'atomic-format-currency': LocalJSX.AtomicFormatCurrency &
        JSXBase.HTMLAttributes<HTMLAtomicFormatCurrencyElement>;
      /**
       * The `atomic-format-number` component is used for number formatting.
       * The numerical format of compatible parents will be set according to the properties of this component.
       */
      'atomic-format-number': LocalJSX.AtomicFormatNumber &
        JSXBase.HTMLAttributes<HTMLAtomicFormatNumberElement>;
      /**
       * The `atomic-format-unit` component is used for formatting numbers with units.
       * The numerical format of compatible parents will be set according to the properties of this component.
       */
      'atomic-format-unit': LocalJSX.AtomicFormatUnit &
        JSXBase.HTMLAttributes<HTMLAtomicFormatUnitElement>;
      /**
       * The `atomic-frequently-bought-together` component suggests products frequently bought with the current product based on the shopping cart of other users.
       */
      ...
      'atomic-generated-answer': LocalJSX.AtomicGeneratedAnswer &
        JSXBase.HTMLAttributes<HTMLAtomicGeneratedAnswerElement>;
      /**
       * The `atomic-html` component renders the HTML value of a string.
       * There is an inherent XSS security concern associated with the usage of this component.
       * Use only with values for which you are certain the content is harmless.
       */
      'atomic-html': LocalJSX.AtomicHtml &
        JSXBase.HTMLAttributes<HTMLAtomicHtmlElement>;
      /**
       * The `atomic-icon` component displays an SVG icon with a 1:1 aspect ratio.
       * This component can display an icon from those available in the Atomic package, from a specific location, or as an inline SVG element.
       */
      'atomic-icon': LocalJSX.AtomicIcon &
        JSXBase.HTMLAttributes<HTMLAtomicIconElement>;
      'atomic-insight-edit-toggle': LocalJSX.AtomicInsightEditToggle &
        JSXBase.HTMLAttributes<HTMLAtomicInsightEditToggleElement>;
      'atomic-insight-facet': LocalJSX.AtomicInsightFacet &
        JSXBase.HTMLAttributes<HTMLAtomicInsightFacetElement>;
      'atomic-insight-folded-result-list': LocalJSX.AtomicInsightFoldedResultList &
        JSXBase.HTMLAttributes<HTMLAtomicInsightFoldedResultListElement>;
      'atomic-insight-full-search-button': LocalJSX.AtomicInsightFullSearchButton &
        JSXBase.HTMLAttributes<HTMLAtomicInsightFullSearchButtonElement>;
      'atomic-insight-history-toggle': LocalJSX.AtomicInsightHistoryToggle &
        JSXBase.HTMLAttributes<HTMLAtomicInsightHistoryToggleElement>;
      'atomic-insight-interface': LocalJSX.AtomicInsightInterface &
        JSXBase.HTMLAttributes<HTMLAtomicInsightInterfaceElement>;
      'atomic-insight-layout': LocalJSX.AtomicInsightLayout &
        JSXBase.HTMLAttributes<HTMLAtomicInsightLayoutElement>;
      'atomic-insight-no-results': LocalJSX.AtomicInsightNoResults &
        JSXBase.HTMLAttributes<HTMLAtomicInsightNoResultsElement>;
      'atomic-insight-numeric-facet': LocalJSX.AtomicInsightNumericFacet &
        JSXBase.HTMLAttributes<HTMLAtomicInsightNumericFacetElement>;
      'atomic-insight-pager': LocalJSX.AtomicInsightPager &
        JSXBase.HTMLAttributes<HTMLAtomicInsightPagerElement>;
      'atomic-insight-query-error': LocalJSX.AtomicInsightQueryError &
        JSXBase.HTMLAttributes<HTMLAtomicInsightQueryErrorElement>;
      'atomic-insight-query-summary': LocalJSX.AtomicInsightQuerySummary &
        JSXBase.HTMLAttributes<HTMLAtomicInsightQuerySummaryElement>;
      'atomic-insight-refine-modal': LocalJSX.AtomicInsightRefineModal &
        JSXBase.HTMLAttributes<HTMLAtomicInsightRefineModalElement>;
      'atomic-insight-refine-toggle': LocalJSX.AtomicInsightRefineToggle &
        JSXBase.HTMLAttributes<HTMLAtomicInsightRefineToggleElement>;
      'atomic-insight-result': LocalJSX.AtomicInsightResult &
        JSXBase.HTMLAttributes<HTMLAtomicInsightResultElement>;
      'atomic-insight-result-action': LocalJSX.AtomicInsightResultAction &
        JSXBase.HTMLAttributes<HTMLAtomicInsightResultActionElement>;
      'atomic-insight-result-action-bar': LocalJSX.AtomicInsightResultActionBar &
        JSXBase.HTMLAttributes<HTMLAtomicInsightResultActionBarElement>;
      'atomic-insight-result-children': LocalJSX.AtomicInsightResultChildren &
        JSXBase.HTMLAttributes<HTMLAtomicInsightResultChildrenElement>;
      'atomic-insight-result-children-template': LocalJSX.AtomicInsightResultChildrenTemplate &
        JSXBase.HTMLAttributes<HTMLAtomicInsightResultChildrenTemplateElement>;
      'atomic-insight-result-list': LocalJSX.AtomicInsightResultList &
        JSXBase.HTMLAttributes<HTMLAtomicInsightResultListElement>;
      'atomic-insight-result-template': LocalJSX.AtomicInsightResultTemplate &
        JSXBase.HTMLAttributes<HTMLAtomicInsightResultTemplateElement>;
      'atomic-insight-search-box': LocalJSX.AtomicInsightSearchBox &
        JSXBase.HTMLAttributes<HTMLAtomicInsightSearchBoxElement>;
      'atomic-insight-smart-snippet': LocalJSX.AtomicInsightSmartSnippet &
        JSXBase.HTMLAttributes<HTMLAtomicInsightSmartSnippetElement>;
      'atomic-insight-smart-snippet-feedback-modal': LocalJSX.AtomicInsightSmartSnippetFeedbackModal &
        JSXBase.HTMLAttributes<HTMLAtomicInsightSmartSnippetFeedbackModalElement>;
      'atomic-insight-smart-snippet-suggestions': LocalJSX.AtomicInsightSmartSnippetSuggestions &
        JSXBase.HTMLAttributes<HTMLAtomicInsightSmartSnippetSuggestionsElement>;
      'atomic-insight-tab': LocalJSX.AtomicInsightTab &
        JSXBase.HTMLAttributes<HTMLAtomicInsightTabElement>;
      'atomic-insight-tabs': LocalJSX.AtomicInsightTabs &
        JSXBase.HTMLAttributes<HTMLAtomicInsightTabsElement>;
      'atomic-insight-timeframe-facet': LocalJSX.AtomicInsightTimeframeFacet &
        JSXBase.HTMLAttributes<HTMLAtomicInsightTimeframeFacetElement>;
      'atomic-ipx-body': LocalJSX.AtomicIpxBody &
        JSXBase.HTMLAttributes<HTMLAtomicIpxBodyElement>;
      'atomic-ipx-button': LocalJSX.AtomicIpxButton &
        JSXBase.HTMLAttributes<HTMLAtomicIpxButtonElement>;
      'atomic-ipx-embedded': LocalJSX.AtomicIpxEmbedded &
        JSXBase.HTMLAttributes<HTMLAtomicIpxEmbeddedElement>;
      'atomic-ipx-modal': LocalJSX.AtomicIpxModal &
        JSXBase.HTMLAttributes<HTMLAtomicIpxModalElement>;
      'atomic-ipx-refine-modal': LocalJSX.AtomicIpxRefineModal &
        JSXBase.HTMLAttributes<HTMLAtomicIpxRefineModalElement>;
      'atomic-ipx-refine-toggle': LocalJSX.AtomicIpxRefineToggle &
        JSXBase.HTMLAttributes<HTMLAtomicIpxRefineToggleElement>;
      'atomic-ipx-tab': LocalJSX.AtomicIpxTab &
        JSXBase.HTMLAttributes<HTMLAtomicIpxTabElement>;
      'atomic-ipx-tabs': LocalJSX.AtomicIpxTabs &
        JSXBase.HTMLAttributes<HTMLAtomicIpxTabsElement>;
      /**
       * The `atomic-layout-section` lets you identify various sections for the related `atomic-layout` component.
       */
      'atomic-layout-section': LocalJSX.AtomicLayoutSection &
        JSXBase.HTMLAttributes<HTMLAtomicLayoutSectionElement>;
      /**
       * The `atomic-load-more-children-results` component allows to load the full collection for a folded result.
       */
      'atomic-load-more-children-results': LocalJSX.AtomicLoadMoreChildrenResults &
        JSXBase.HTMLAttributes<HTMLAtomicLoadMoreChildrenResultsElement>;
      /**
       * The `atomic-load-more-results` component allows the user to load additional results if more are available.
       */
      'atomic-load-more-results': LocalJSX.AtomicLoadMoreResults &
        JSXBase.HTMLAttributes<HTMLAtomicLoadMoreResultsElement>;
      /**
       * When the modal is opened, the class `atomic-modal-opened` is added to the interfaceElement and the body, allowing further customization.
       */
      'atomic-modal': LocalJSX.AtomicModal &
        JSXBase.HTMLAttributes<HTMLAtomicModalElement>;
      /**
       * The `atomic-no-results` component displays search tips and a "Cancel last action" button when there are no results. Any additional content slotted inside of its element will be displayed as well.
       */
       ...
       * The `atomic-notifications` component is responsible for displaying notifications generated by the Coveo Search API (see [Trigger](https://docs.coveo.com/en/1458)).
       */
      'atomic-notifications': LocalJSX.AtomicNotifications &
        JSXBase.HTMLAttributes<HTMLAtomicNotificationsElement>;
      /**
       * A facet is a list of values for a certain field occurring in the results, ordered using a configurable criteria (e.g., ascending, descending).
       * An `atomic-numeric-facet` displays a facet of the results for the current query as numeric ranges.
       */
       ...
       * The `atomic-popover` component displays any facet as a popover menu.
       */
      'atomic-popover': LocalJSX.AtomicPopover &
        JSXBase.HTMLAttributes<HTMLAtomicPopoverElement>;
      /**
       * The `atomic-query-error` component handles fatal errors when performing a query on the index or Search API. When the error is known, it displays a link to relevant documentation link for debugging purposes. When the error is unknown, it displays a small text area with the JSON content of the error.
       */
       ...
       * images/links may not work as expected in an `atomic-quickview`).
       */
      'atomic-quickview': LocalJSX.AtomicQuickview &
        JSXBase.HTMLAttributes<HTMLAtomicQuickviewElement>;
      'atomic-quickview-modal': LocalJSX.AtomicQuickviewModal &
        JSXBase.HTMLAttributes<HTMLAtomicQuickviewModalElement>;
      /**
       * A facet is a list of values for a certain field occurring in the results, ordered using a configurable criteria (e.g., number of occurrences).
       * An `atomic-rating-facet` displays a facet of the results for the current query as ratings.
       * It only supports numeric fields.
       */
      'atomic-rating-facet': LocalJSX.AtomicRatingFacet &
        JSXBase.HTMLAttributes<HTMLAtomicRatingFacetElement>;
      /**
       * A facet is a list of values for a certain field occurring in the results, ordered using a configurable criteria (e.g., number of occurrences).
       * An `atomic-rating-range-facet` displays a facet of the results for the current query as ratings.
       * It only supports numeric fields.
       */
      'atomic-rating-range-facet': LocalJSX.AtomicRatingRangeFacet &
        JSXBase.HTMLAttributes<HTMLAtomicRatingRangeFacetElement>;
      /**
       * The `atomic-recs-error` component handles fatal errors when performing a recommendations request on the index or Search API. When the error is known, it displays a link to relevant documentation link for debugging purposes. When the error is unknown, it displays a small text area with the JSON content of the error.
       */
      'atomic-recs-error': LocalJSX.AtomicRecsError &
        JSXBase.HTMLAttributes<HTMLAtomicRecsErrorElement>;
      /**
       * The `atomic-recs-interface` component is the parent to all other atomic components in a recommendation interface. It handles the headless recommendation engine and localization configurations.
       */
      'atomic-recs-interface': LocalJSX.AtomicRecsInterface &
        JSXBase.HTMLAttributes<HTMLAtomicRecsInterfaceElement>;
      /**
       * The `atomic-recs-list` component displays recommendations by applying one or more result templates.
       */
      'atomic-recs-list': LocalJSX.AtomicRecsList &
        JSXBase.HTMLAttributes<HTMLAtomicRecsListElement>;
      /**
       * The `atomic-recs-result` component is used internally by the `atomic-recs-list` component.
       */
      'atomic-recs-result': LocalJSX.AtomicRecsResult &
        JSXBase.HTMLAttributes<HTMLAtomicRecsResultElement>;
      /**
       * The `atomic-recs-result-template` component determines the format of the query results, depending on the conditions that are defined for each template. A `template` element must be the child of an `atomic-recs-result-template`, and an `atomic-recs-list` must be the parent of each `atomic-recs-result-template`.
       * Note: Any `<script>` tags defined inside of a `<template>` element will not be executed when results are being rendered.
       * @MapProp name: mustMatch;attr: must-match;docs: The field and values that define which result items the condition must be applied to. For example, a template with the following attribute only applies to result items whose `filetype` is `lithiummessage` or `YouTubePlaylist`: `must-match-filetype="lithiummessage,YouTubePlaylist"`;type: Record<string, string[]> ;default: {}
       * @MapProp name: mustNotMatch;attr: must-not-match;docs: The field and values that define which result items the condition must not be applied to. For example, a template with the following attribute only applies to result items whose `filetype` is not `lithiummessage`: `must-not-match-filetype="lithiummessage";type: Record<string, string[]> ;default: {}
       */
      'atomic-recs-result-template': LocalJSX.AtomicRecsResultTemplate &
        JSXBase.HTMLAttributes<HTMLAtomicRecsResultTemplateElement>;
      /**
       * The `atomic-refine-modal` is automatically created as a child of the `atomic-search-interface` when the `atomic-refine-toggle` is initialized.
       * When the modal is opened, the class `atomic-modal-opened` is added to the interface element and the body, allowing further customization.
       */
      'atomic-refine-modal': LocalJSX.AtomicRefineModal &
        JSXBase.HTMLAttributes<HTMLAtomicRefineModalElement>;
      /**
       * The `atomic-refine-toggle` component displays a button that opens a modal containing the facets and the sort components.
       * When this component is added to the `atomic-search-interface`, an `atomic-refine-modal` component is automatically created.
       */
      'atomic-refine-toggle': LocalJSX.AtomicRefineToggle &
        JSXBase.HTMLAttributes<HTMLAtomicRefineToggleElement>;
      /**
       * The `atomic-relevance-inspector` component is used internally to offer insight on search page relevance, as well as information to help troubleshoot issues during development.
       */
       ...
       * ```
       */
      'atomic-result-badge': LocalJSX.AtomicResultBadge &
        JSXBase.HTMLAttributes<HTMLAtomicResultBadgeElement>;
      /**
       * The `atomic-result-children` component is responsible for displaying child results by applying one or more child result templates.
       * Includes two slots, "before-children" and "after-children", which allow for rendering content before and after the list of children,
       * only when children exist.
       */
      'atomic-result-children': LocalJSX.AtomicResultChildren &
        JSXBase.HTMLAttributes<HTMLAtomicResultChildrenElement>;
      /**
       * The `atomic-result-children-template` component determines the format of the child results, depending on the conditions that are defined for each template. A `template` element must be the child of an `atomic-result-children-template`, and an `atomic-result-children` must be the parent of each `atomic-result-children-template`.
       * Note: Any `<script>` tags defined inside of a `<template>` element will not be executed when results are being rendered.
       * @MapProp name: mustMatch;attr: must-match;docs: The field and values that define which result items the condition must be applied to. For example, a template with the following attribute only applies to result items whose `filetype` is `lithiummessage` or `YouTubePlaylist`: `must-match-filetype="lithiummessage,YouTubePlaylist"`;type: Record<string, string[]> ;default: {}
       * @MapProp name: mustNotMatch;attr: must-not-match;docs: The field and values that define which result items the condition must not be applied to. For example, a template with the following attribute only applies to result items whose `filetype` is not `lithiummessage`: `must-not-match-filetype="lithiummessage";type: Record<string, string[]> ;default: {}
       */
      'atomic-result-children-template': LocalJSX.AtomicResultChildrenTemplate &
        JSXBase.HTMLAttributes<HTMLAtomicResultChildrenTemplateElement>;
      /**
       * The `atomic-result-date` component renders the value of a date result field.
       */
      'atomic-result-date': LocalJSX.AtomicResultDate &
        JSXBase.HTMLAttributes<HTMLAtomicResultDateElement>;
      /**
       * The `atomic-result-fields-list` component selectively renders its children to ensure they fit the parent element and adds dividers between them.
       */
      'atomic-result-fields-list': LocalJSX.AtomicResultFieldsList &
        JSXBase.HTMLAttributes<HTMLAtomicResultFieldsListElement>;
      /**
       * The `atomic-result-html` component renders the HTML value of a string result field.
       * There is an inherent XSS security concern associated with the usage of this component.
       * Use only with fields for which you are certain the data is harmless.
       */
      'atomic-result-html': LocalJSX.AtomicResultHtml &
        JSXBase.HTMLAttributes<HTMLAtomicResultHtmlElement>;
      /**
       * The `atomic-result-icon` component outputs the corresponding icon for a given file type.
       * The component searches for a suitable icon, or outputs a generic icon if the search is unsuccessful.
       */
      'atomic-result-icon': LocalJSX.AtomicResultIcon &
        JSXBase.HTMLAttributes<HTMLAtomicResultIconElement>;
      /**
       * The `atomic-result-image` component renders an image from a result field.
       */
      'atomic-result-image': LocalJSX.AtomicResultImage &
        JSXBase.HTMLAttributes<HTMLAtomicResultImageElement>;
      /**
       * The `atomic-result-link` component automatically transforms a search result title into a clickable link that points to the original item.
       */
       ...
       * @MapProp name: field;attr: field;docs: The field from which to extract the target string and the variable used to map it to the target i18n parameter. For example, the following configuration extracts the value of `author` from a result, and assign it to the i18n parameter `name`: `field-author="name"`;type: Record<string, string> ;default: {}
       */
      'atomic-result-localized-text': LocalJSX.AtomicResultLocalizedText &
        JSXBase.HTMLAttributes<HTMLAtomicResultLocalizedTextElement>;
      /**
       * The `atomic-result-multi-value-text` component renders the values of a multi-value string field.
       */
      'atomic-result-multi-value-text': LocalJSX.AtomicResultMultiValueText &
        JSXBase.HTMLAttributes<HTMLAtomicResultMultiValueTextElement>;
      /**
       * The `atomic-result-number` component renders the value of a number result field.
       * The number can be formatted by adding a `atomic-format-number`, `atomic-format-currency` or `atomic-format-unit` component into this component.
       */
      'atomic-result-number': LocalJSX.AtomicResultNumber &
        JSXBase.HTMLAttributes<HTMLAtomicResultNumberElement>;
      /**
       * The `atomic-result-placeholder` component provides an intermediate visual state that is rendered before the first results are available.
       */
      'atomic-result-placeholder': LocalJSX.AtomicResultPlaceholder &
        JSXBase.HTMLAttributes<HTMLAtomicResultPlaceholderElement>;
      /**
       * The `atomic-result-printable-uri` component displays the URI, or path, to access a result.
       */
       ...
       * The `atomic-result-rating` element renders a star rating.
       */
      'atomic-result-rating': LocalJSX.AtomicResultRating &
        JSXBase.HTMLAttributes<HTMLAtomicResultRatingElement>;
      /**
       * This section allows the information seeker to perform an action on an item without having to view its details.
       * For example, in Commerce you can add an item to the cart directly or add it to a wish list to view at a later time.
       * Behavior:
       ...
       * * May appear over, next to, or beneath the visual section.
       */
      'atomic-result-section-actions': LocalJSX.AtomicResultSectionActions &
        JSXBase.HTMLAttributes<HTMLAtomicResultSectionActionsElement>;
      /**
       * This section provides badges that highlight special features of the item.
       * Behavior:
       * * Exposes the `--line-height` CSS variable so child elements can adjust to the current line height.
       ...
       * * May appear over, next to, or beneath the visual section.
       */
      'atomic-result-section-badges': LocalJSX.AtomicResultSectionBadges &
        JSXBase.HTMLAttributes<HTMLAtomicResultSectionBadgesElement>;
      /**
       * This section displays additional descriptive information about the item.
       * Behavior:
       * * Has a maximum height of two lines.
       ...
       * * Has a font weight.
       */
      'atomic-result-section-bottom-metadata': LocalJSX.AtomicResultSectionBottomMetadata &
        JSXBase.HTMLAttributes<HTMLAtomicResultSectionBottomMetadataElement>;
      /**
       * This section displays the folded results, available when using the <atomic-result-children> component.
       * Behavior:
       * * Shows children at the bottom of the result, indented and wrapped in a border.
       */
      'atomic-result-section-children': LocalJSX.AtomicResultSectionChildren &
        JSXBase.HTMLAttributes<HTMLAtomicResultSectionChildrenElement>;
      /**
       * This section displays the field that's important for its search criteria.
       * For example, in Commerce, a product's cost is often more important than the title itself.
       * Behavior:
       ...
       * * Is the second closest element beneath the title section.
       */
      'atomic-result-section-emphasized': LocalJSX.AtomicResultSectionEmphasized &
        JSXBase.HTMLAttributes<HTMLAtomicResultSectionEmphasizedElement>;
      /**
       * This section contains an informative summary of the item's content.
       * Behavior:
       * * Has a fixed height of one to three lines, depending on the layout and density.
       ...
       * * Has a defined CSS `color` property for text.
       */
      'atomic-result-section-excerpt': LocalJSX.AtomicResultSectionExcerpt &
        JSXBase.HTMLAttributes<HTMLAtomicResultSectionExcerptElement>;
      /**
       * This section identifies the item by its name, and its main use is to make the result list scannable.
       * This is usually the page title.
       * Behavior:
       ...
       * * Has a defined CSS `color` property for text.
       */
      'atomic-result-section-title': LocalJSX.AtomicResultSectionTitle &
        JSXBase.HTMLAttributes<HTMLAtomicResultSectionTitleElement>;
      /**
       * This section surfaces some fields that are directly related to the title of the item.
       * For example, in Commerce, this could be the item's rating, which is tied to the nature of the product itself,
       * rather than to the product's description.
       ...
       * * Is the closest element beneath the title section.
       */
      'atomic-result-section-title-metadata': LocalJSX.AtomicResultSectionTitleMetadata &
        JSXBase.HTMLAttributes<HTMLAtomicResultSectionTitleMetadataElement>;
      /**
       * This section provides visual information about the item.
       * For example, in Commerce, an image is a great shorthand for a product category.
       * An icon can quickly show the item type, or an avatar can help identify to whom it is related.
       ...
       * * Always has a 1:1 aspect ratio.
       */
      'atomic-result-section-visual': LocalJSX.AtomicResultSectionVisual &
        JSXBase.HTMLAttributes<HTMLAtomicResultSectionVisualElement>;
      /**
       * The `atomic-result-table-placeholder` component provides an intermediate visual state that is rendered before the first results are available.
       */
      'atomic-result-table-placeholder': LocalJSX.AtomicResultTablePlaceholder &
        JSXBase.HTMLAttributes<HTMLAtomicResultTablePlaceholderElement>;
      /**
       * The `atomic-result-template` component determines the format of the query results, depending on the conditions that are defined for each template. A `template` element must be the child of an `atomic-result-template`, and either an `atomic-result-list` or `atomic-folded-result-list` must be the parent of each `atomic-result-template`.
       * Note: Any `<script>` tags defined inside of a `<template>` element will not be executed when results are being rendered.
       * @MapProp name: mustMatch;attr: must-match;docs: The field and values that define which result items the condition must be applied to. For example, a template with the following attribute only applies to result items whose `filetype` is `lithiummessage` or `YouTubePlaylist`: `must-match-filetype="lithiummessage,YouTubePlaylist"`;type: Record<string, string[]> ;default: {}
       ...
       * The `atomic-result-text` component renders the value of a string result field.
       */
      'atomic-result-text': LocalJSX.AtomicResultText &
        JSXBase.HTMLAttributes<HTMLAtomicResultTextElement>;
      /**
       * The `atomic-result-timespan` component renders a target result number field value as a duration.
       */
      'atomic-result-timespan': LocalJSX.AtomicResultTimespan &
        JSXBase.HTMLAttributes<HTMLAtomicResultTimespanElement>;
      /**
       * The `atomic-results-per-page` component determines how many results to display per page.
       */
       ...
       * This component does not support accessibility out-of-the-box. To do so, see [Instant Results Accessibility](https://docs.coveo.com/en/atomic/latest/usage/accessibility/#instant-results-accessibility).
       */
      'atomic-search-box-instant-results': LocalJSX.AtomicSearchBoxInstantResults &
        JSXBase.HTMLAttributes<HTMLAtomicSearchBoxInstantResultsElement>;
      /**
       * The `atomic-search-box-query-suggestions` component can be added as a child of an `atomic-search-box` component, allowing for the configuration of query suggestion behavior.
       */
      'atomic-search-box-query-suggestions': LocalJSX.AtomicSearchBoxQuerySuggestions &
        JSXBase.HTMLAttributes<HTMLAtomicSearchBoxQuerySuggestionsElement>;
      /**
       * The `atomic-search-box-recent-queries` component can be added as a child of an `atomic-search-box` component, allowing for the configuration of recent query suggestions.
       */
      'atomic-search-box-recent-queries': LocalJSX.AtomicSearchBoxRecentQueries &
        JSXBase.HTMLAttributes<HTMLAtomicSearchBoxRecentQueriesElement>;
      /**
       * The `atomic-search-interface` component is the parent to all other atomic components in a search page. It handles the headless search engine and localization configurations.
       */
       ...
       * The `atomic-search-layout` helps organize elements in the page.
       */
      'atomic-search-layout': LocalJSX.AtomicSearchLayout &
        JSXBase.HTMLAttributes<HTMLAtomicSearchLayoutElement>;
      /**
       * The `atomic-segmented-facet` displays a horizontal facet of the results for the current query.
       */
      'atomic-segmented-facet': LocalJSX.AtomicSegmentedFacet &
        JSXBase.HTMLAttributes<HTMLAtomicSegmentedFacetElement>;
      /**
       * The 'atomic-segmented-facet-scrollable' component wraps around one or several 'atomic-segmented-facet' to provide horizontal scrolling capabilities.
       */
      'atomic-segmented-facet-scrollable': LocalJSX.AtomicSegmentedFacetScrollable &
        JSXBase.HTMLAttributes<HTMLAtomicSegmentedFacetScrollableElement>;
      /**
       * The `atomic-smart-snippet` component displays the excerpt of a document that would be most likely to answer a particular query.
       * You can style the snippet by inserting a template element as follows:
       * ```html
       ...
       * ```
       */
      'atomic-smart-snippet': LocalJSX.AtomicSmartSnippet &
        JSXBase.HTMLAttributes<HTMLAtomicSmartSnippetElement>;
      'atomic-smart-snippet-answer': LocalJSX.AtomicSmartSnippetAnswer &
        JSXBase.HTMLAttributes<HTMLAtomicSmartSnippetAnswerElement>;
      'atomic-smart-snippet-collapse-wrapper': LocalJSX.AtomicSmartSnippetCollapseWrapper &
        JSXBase.HTMLAttributes<HTMLAtomicSmartSnippetCollapseWrapperElement>;
      'atomic-smart-snippet-expandable-answer': LocalJSX.AtomicSmartSnippetExpandableAnswer &
        JSXBase.HTMLAttributes<HTMLAtomicSmartSnippetExpandableAnswerElement>;
      /**
       * The `atomic-smart-snippet-feedback-modal` is automatically created as a child of the `atomic-search-interface` when the `atomic-smart-snippet` is initialized.
       * When the modal is opened, the class `atomic-modal-opened` is added to the body, allowing further customization.
       */
      'atomic-smart-snippet-feedback-modal': LocalJSX.AtomicSmartSnippetFeedbackModal &
        JSXBase.HTMLAttributes<HTMLAtomicSmartSnippetFeedbackModalElement>;
      'atomic-smart-snippet-source': LocalJSX.AtomicSmartSnippetSource &
        JSXBase.HTMLAttributes<HTMLAtomicSmartSnippetSourceElement>;
      /**
       * The `atomic-smart-snippet-suggestions-suggestions` component displays an accordion of questions related to the query with their corresponding answers.
       * You can style the snippets by inserting a template element like this:
       * ```html
       ...
       * ```
       */
      'atomic-smart-snippet-suggestions': LocalJSX.AtomicSmartSnippetSuggestions &
        JSXBase.HTMLAttributes<HTMLAtomicSmartSnippetSuggestionsElement>;
      /**
       * The `atomic-sort-dropdown` component renders a dropdown that the end user can interact with to select the criteria to use when sorting query results.
       */
       ...
       * The `atomic-sort-expression` component defines a sort expression. This component must be inside an `atomic-sort-dropdown` component.
       */
      'atomic-sort-expression': LocalJSX.AtomicSortExpression &
        JSXBase.HTMLAttributes<HTMLAtomicSortExpressionElement>;
      /**
       * The `atomic-table-element` element defines a table column in a result list.
       */
      'atomic-table-element': LocalJSX.AtomicTableElement &
        JSXBase.HTMLAttributes<HTMLAtomicTableElementElement>;
      /**
       * The `atomic-text` component leverages the I18n translation module through the atomic-search-interface.
       */
       ...
       * A timeframe is a span of time from now to a specific time in the past.
       */
      'atomic-timeframe': LocalJSX.AtomicTimeframe &
        JSXBase.HTMLAttributes<HTMLAtomicTimeframeElement>;
      /**
       * A facet is a list of values for a certain field occurring in the results.
       * An `atomic-timeframe-facet` displays a facet of the results for the current query as date intervals.
       */
      'atomic-timeframe-facet': LocalJSX.AtomicTimeframeFacet &
        JSXBase.HTMLAttributes<HTMLAtomicTimeframeFacetElement>;
      'tab-bar': LocalJSX.TabBar & JSXBase.HTMLAttributes<HTMLTabBarElement>;
      'tab-popover': LocalJSX.TabPopover &
        JSXBase.HTMLAttributes<HTMLTabPopoverElement>;
    }
  }
}
