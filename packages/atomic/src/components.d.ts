...
export namespace Components {
     ...
     * **This component should never be used directly in your application.** It is exclusively for
     * internal use by the atomic-automatic-facet-generator to render updated facets automatically.
     * **Use this documentation only to style the shadow parts of the generated facets.**
