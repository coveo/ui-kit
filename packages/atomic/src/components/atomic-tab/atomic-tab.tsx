...
/**
 * The `atomic-tab` component renders a widget that allows the end user to select a specific search interface based on a constant expression applied to the outgoing query.
