...
describe('utils', () => {
  ...
  describe('#getErrorTitleFromErrorType', () => {
    it('should return the correct title when errorType is "Disconnected"', () => {
      expect(getErrorTitleFromErrorType(i18n, orgId, 'Disconnected')).toBe('No access.');
    });

    it('should return the correct title when errorType is "NoEndpointsException"', () => {
      expect(getErrorTitleFromErrorType(i18n, orgId, 'InvalidToken')).toBe('Something went wrong.');
    });

    it('should return the correct title when errorType is "InvalidTokenException"', () => {
      expect(getErrorTitleFromErrorType(i18n, orgId, 'InvalidTokenException')).toBe(
        'Your organization org123 cannot be accessed.'
      );
    });

    it('should return the correct title when errorType is "OrganizationIsPausedException"', () => {
      expect(getErrorTitleFromErrorType(i18n, orgId, 'OrganizationIsPausedException')).toBe(
    ...
    it('should return the default title for unknown error types', () => {
      expect(getErrorTitleFromErrorType(i18n, orgId, 'UnknownError')).toBe('Something went wrong.');
    });
  });

  describe('#getErrorDescriptionFromErrorType', () => {
    it('should return the correct description for "Disconnected"', () => {
      expect(getErrorDescriptionFromErrorType(i18n, orgId, platformUrl, 'Disconnected')).toBe(
    ...
    it('should return the correct description for "NoEndpointsException"', () => {
      expect(
        getErrorDescriptionFromErrorType(i18n, orgId, platformUrl, 'NoEndpointsException')
      ).toBe('Add content sources or wait for your newly created sources to finish indexing.');
    });

    it('should return the correct description for "InvalidTokenException"', () => {
      expect(
        getErrorDescriptionFromErrorType(i18n, orgId, platformUrl, 'InvalidTokenException')
      ).toBe('Ensure that the token is valid.');
    });

    it('should return the correct description for "OrganizationIsPausedException"', () => {
      expect(
        getErrorDescriptionFromErrorType(i18n, orgId, platformUrl, 'OrganizationIsPausedException')
    ...
    it('should return a generic description for unknown error types', () => {
      expect(getErrorDescriptionFromErrorType(i18n, orgId, platformUrl, 'UnknownError')).toBe(
  ...
  describe('#getAriaMessageFromErrorType', () => {
    it('should return the correct aria message for "Disconnected"', () => {
      expect(getAriaMessageFromErrorType(i18n, orgId, platformUrl, 'Disconnected')).toBe(
    ...
    it('should return the correct aria message for "NoEndpointsException"', () => {
      expect(getAriaMessageFromErrorType(i18n, orgId, platformUrl, 'NoEndpointsException')).toBe(
    ...
    it('should return the correct aria message for "InvalidTokenException"', () => {
      expect(getAriaMessageFromErrorType(i18n, orgId, platformUrl, 'InvalidTokenException')).toBe(
    ...
    it('should return the correct aria message for "OrganizationIsPausedException"', () => {
      expect(
        getAriaMessageFromErrorType(i18n, orgId, platformUrl, 'OrganizationIsPausedException')
      ).toBe(
    ...
    it('should return the correct aria message for unknown error types', () => {
      expect(getAriaMessageFromErrorType(i18n, orgId, platformUrl, 'UnknownError')).toBe(
