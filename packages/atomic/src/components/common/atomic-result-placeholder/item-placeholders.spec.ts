...
import {type ItemPlaceholdersProps, renderItemPlaceholders} from './item-placeholders';

describe('renderItemPlaceholders', () => {
  const itemPlaceholdersFixture = async (props: Partial<ItemPlaceholdersProps> = {}) => {
  ...
  describe("when #display is 'table'", () => {
    it('should render an atomic-result-table-placeholder element in the document', async () => {
      ...
      const atomicResultTablePlaceholderElements = itemPlaceholders.querySelectorAll(
    ...
    it("should apply the #density prop value to the placeholder element's 'density' attribute", async () => {
      ...
      const atomicTableResultPlaceholderElement = itemPlaceholders.querySelector(
        'atomic-result-table-placeholder'
      );
    ...
    it("should apply the #numberOfPlaceholders prop value to the placeholder element's 'rows' attribute", async () => {
      ...
      const placeholderElement = itemPlaceholders.querySelector('atomic-result-table-placeholder');
