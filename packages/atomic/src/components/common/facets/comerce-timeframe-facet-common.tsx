...
export interface CommerceTimeframe {
...
interface CommerceTimeframeFacetCommonOptions {
  facetId?: string;
  facet: DateFacet; // TODO: find a way to accept multiple facet types
  host: HTMLElement;
  ...
  getSummaryState(): SearchSummaryState | ListingSummaryState;
...
interface CommerceTimeframeFacetCommonRenderProps {
  hasError: boolean;
...
export class CommerceTimeframeFacetCommon {
  ...
  private manualTimeframes: CommerceTimeframe[] = [];
  private dependenciesManager?: FacetConditionsManager;

  constructor(private props: CommerceTimeframeFacetCommonOptions) {
    ...
    // TODO: NEED TO SUPPORT MANUAL TIMEFRAMES!!
    ...
    //   // this.filter = this.props.initializeFilter(); // TODO: figure the purpose of date filter
    // }
  ...
  public get currentValues(): DateRangeRequest[] {
    // TODO: check if this is already done by the API
  ...
  private getManualTimeframes(): CommerceTimeframe[] {
  ...
  public render({
    ...
    headerFocus,
    onToggleCollapse,
  }: CommerceTimeframeFacetCommonRenderProps) {
    if (hasError) {
