...
const baseStyle = css`
  ...
  /**
   * @prop --atomic-generated-answer-fixed-height: The fixed height of the generated answer content when agent-id is set.
   */
  [part='generated-content-container'].agent-scrollable {
    @apply overflow-y-auto;
    height: var(--atomic-generated-answer-fixed-height, 24rem);
  }
