...
export class ResultTemplateController extends BaseTemplateController<ResultTemplateCondition> {
  constructor(host: ResultTemplateHost, validParents: string[], allowEmpty: boolean = false) {
    super(host, validParents, allowEmpty);
  }

  getTemplate(conditions: ResultTemplateCondition[]): ResultTemplate<TemplateContent> | null {
