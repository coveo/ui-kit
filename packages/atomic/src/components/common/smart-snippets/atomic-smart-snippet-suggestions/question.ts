...
import {getQuestionPart} from './question-part';
...
export const renderSmartSnippetSuggestionsQuestion: FunctionalComponentWithChildren<SmartSnippetSuggestionsQuestionProps> =
  ({props}) =>
  (children) => {
