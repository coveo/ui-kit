...
describe('display-options', () => {
  ...
  describe('ItemLayout', () => {
    ...
    beforeEach(() => {
      // Create mock children collection
      ...
      // Reset mock
      mockContainsSections.mockReset();
    });
    ...
    describe('#getClasses', () => {
      ...
      it('should use image size from visual section when present', () => {
        ...
        // Should use 'large' from the visual section, not 'icon' from constructor
        expect(classes).toEqual([
          'display-list',
          'density-normal',
          'image-large',
      ...
      it('should fallback to constructor image size when no visual section', () => {
        // Create layout without visual section
      ...
      it('should handle different display, density, and image combinations', () => {
        ...
        expect(classes).toEqual([
          'display-table',
          'density-comfortable',
          'image-large', // Still uses visual section image size
          'with-sections',
        ]);
      });
    });
