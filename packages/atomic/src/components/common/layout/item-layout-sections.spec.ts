...
describe('item-layout-sections', () => {
  describe('#isResultSectionNode', () => {
    describe('with section elements', () => {
      it.each(validSectionTags)('should return true for %s element', (tagName) => {
  ...
  describe('#containsSections', () => {
    ...
    describe('with NodeList content', () => {
      ...
      describe.each(validSectionTags)('when NodeList contains %s', (tagName) => {
      ...
      describe.each(invalidTags)('when NodeList contains only %s elements', (tagName) => {
        it('should return false', () => {
          const element = document.createElement(tagName);
      ...
      it('should return true when section is mixed with other nodes', () => {
        ...
        const sectionElement = document.createElement('atomic-result-section-actions');
    ...
    describe('with HTMLCollection content', () => {
      ...
      describe.each(validSectionTags)('when HTMLCollection contains %s', (tagName) => {
        it('should return true', () => {
          const sectionElement = document.createElement(tagName);
          container.appendChild(sectionElement);
      ...
      describe.each(invalidTags)('when HTMLCollection contains only %s elements', (tagName) => {
        it('should return false', () => {
          const element = document.createElement(tagName);
          container.appendChild(element);
      ...
      it('should return true when section is mixed with other elements', () => {
        ...
        const sectionElement = document.createElement('atomic-result-section-title');
      ...
      it('should return true when HTMLCollection contains multiple different section types', () => {
        const resultSection = document.createElement('atomic-result-section-visual');
        const productSection = document.createElement('atomic-product-section-emphasized');
