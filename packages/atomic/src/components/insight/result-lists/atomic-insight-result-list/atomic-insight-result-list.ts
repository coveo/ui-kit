...
import insightListDisplayStyles from './atomic-insight-result-list.tw.css';

/**
 * The `atomic-insight-result-list` component is responsible for displaying query results by applying one or more result templates.
 *
 * @internal
  ...
  implements InitializableComponent<InsightBindings>
{
  ...
  private getContent(result: InsightResult) {
