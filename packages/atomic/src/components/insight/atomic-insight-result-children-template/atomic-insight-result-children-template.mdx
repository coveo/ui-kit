...
This component defines the UI display of child results within an `atomic-insight-result-children` component.
A `template` element must be the child of an `atomic-insight-result-children-template`. Furthermore, an `atomic-insight-result-children` must be the parent of each `atomic-insight-result-children-template`.
