...
test.describe('atomic-insight-refine-modal', () => {
  ...
  test('should render the modal properly after the user opens it', async ({refineModal}) => {
  ...
  test('should close the modal properly after the user closes it', async ({refineModal}) => {
    await expect(refineModal.title).toBeVisible();
