...
import {shouldUpdateFacetSearchComponent} from '../../common/facets/facet-search/facet-search-utils';
 ...
 */
@Component({
  tag: 'atomic-product-listing-category-facet',
  styleUrl: 'atomic-product-listing-category-facet.pcss',
  shadow: true,
})
