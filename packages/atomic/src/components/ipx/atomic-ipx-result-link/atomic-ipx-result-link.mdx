...
The `atomic-ipx-result-link` component automatically transforms a search result **title** into a clickable link that points to the original item. This component is used within result templates in the IPX (In-Product Experience) context.

**Note:** This is an internal component designed specifically for IPX use cases.

## Usage

This component is typically used within `atomic-recs-result-template` in an IPX context:
