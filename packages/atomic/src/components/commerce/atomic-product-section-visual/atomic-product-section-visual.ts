...
import type {ItemDisplayImageSize} from '@/src/components/common/layout/display-options.js';
import {hideEmptySection} from '@/src/utils/item-section-utils.js';
...
export class AtomicProductSectionVisual extends LitElement {
  /**
