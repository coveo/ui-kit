...
test.describe('atomic-product-price', () => {
  ...
  test.describe('when there is a promotional price', async () => {
    ...
    test('should render the original price with a line-through', async ({productPrice}) => {
    ...
    test('should render the promotional price with a text-error', async ({productPrice}) => {
