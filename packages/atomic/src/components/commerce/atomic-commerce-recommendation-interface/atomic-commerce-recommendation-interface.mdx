  ...
  additionalActions={[
    {
      ...
      onClick: () => {
        window.open(
          'https://github.com/coveo/ui-kit/blob/main/packages/atomic/src/components/commerce/atomic-commerce-recommendation-interface/atomic-commerce-recommendation-interface.ts',
          '_blank'
        );
      },
    },
