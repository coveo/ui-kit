  ...
  additionalActions={[
    {
      ...
      onClick: () => {
        window.open(
          'https://github.com/coveo/ui-kit/blob/main/packages/atomic/src/components/commerce/product-template-components/atomic-product-text/atomic-product-text.ts',
          '_blank'
        );
      },
    },
