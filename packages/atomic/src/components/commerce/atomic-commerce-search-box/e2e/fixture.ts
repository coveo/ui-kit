...
import type {FacetsPageObject} from '../../atomic-commerce-facets/e2e/page-object';
import type {LoadMoreProductsPageObject} from '../../atomic-commerce-load-more-products/e2e/page-object';
