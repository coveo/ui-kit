...
// /**
//  * The `stencil-atomic-commerce-facet` component renders a commerce facet that the end user can interact with to filter products.
//  *
...
//  */
// @Component({
//   tag: 'stencil-atomic-commerce-facet',
//   styleUrl: 'stencil-atomic-commerce-facet.pcss',
//   shadow: true,
// })
