...
//  * An `atomic-commerce-numeric-facet` displays a facet of the results for the current query as numeric ranges.
//  *
...
//   shadow: true,
// })
// export class AtomicCommerceNumericFacet implements InitializableComponent<Bindings> {
