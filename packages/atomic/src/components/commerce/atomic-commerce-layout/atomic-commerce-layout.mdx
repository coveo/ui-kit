...
This component is used to organize the layout of the commerce page. 
You must use `atomic-layout-section` to define the different sections of the page, such as **search**, **facets**, and **main**.
