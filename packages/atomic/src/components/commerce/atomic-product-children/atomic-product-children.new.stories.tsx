...
const {events, args, argTypes, template} = getStorybookHelpers('atomic-product-children', {
...
const meta: Meta = {
  ...
  decorators: [
    (story) => html`
      <atomic-product-section-children id="code-root"> ${story()} </atomic-product-section-children>
    `,
