...
When [displaying products as a list or grid](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-display-results-display-results-as-a-list-or-grid--docs), the component applies a basic template by default. You can also [define custom templates](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-display-results-introduction--docs#defining-a-result-template).
...
When [displaying products as a table](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-display-results-display-results-as-a-table--docs), there is no default template. You must define a template that includes at least one `atomic-table-element` component, which serve as columns.
