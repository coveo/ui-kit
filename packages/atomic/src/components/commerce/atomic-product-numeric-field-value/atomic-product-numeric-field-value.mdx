  ...
  additionalActions={[
    {
      ...
      onClick: () => {
        window.open(
          'https://github.com/coveo/ui-kit/blob/master/packages/atomic/src/components/commerce/atomic-product-numeric-field-value/atomic-product-numeric-field-value.ts',
          '_blank'
        );
      },
    },
