...
<atomic-result-template>
  ...
  <atomic-field-condition if-defined="author">
    <span
      >Written by: <atomic-result-text field="author"></atomic-result-text
    ></span>
  ...
  <atomic-field-condition if-defined="author" must-not-match-source="internal">
    <span
      >External author: <atomic-result-text field="author"></atomic-result-text
    ></span>
  </atomic-field-condition>

  <!-- This will never render (conflicting conditions) -->
  <atomic-field-condition
    must-match-filetype="pdf"
    must-not-match-filetype="pdf"
  >
