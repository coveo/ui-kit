...
## UX Best Practices
- **Field names provide context for the selected value**: displaying the field name next to the selected value clarifies which facet the breadcrumb value associated with.
