...
- On an ecommerce site, users will often view more products using a Load More button than with a Pager.
- When designing for mobile, a Load More button can provide a better experience for many users.
