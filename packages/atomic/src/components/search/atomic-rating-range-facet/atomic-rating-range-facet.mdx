...
```html
<atomic-rating-range-facet field="snrating" label="Star Rating">
</atomic-rating-range-facet>
```
...
```html
<atomic-rating-range-facet field="rating" icon="assets://heart.svg">
</atomic-rating-range-facet>
```
...
<atomic-rating-range-facet field="rating" tabs-excluded='["documentation"]'>
</atomic-rating-range-facet>
```
...
<atomic-rating-range-facet field="rating" depends-on-producttype="Electronics">
</atomic-rating-range-facet>
```
...
```html
<atomic-rating-range-facet field="rating" injection-depth="2000">
</atomic-rating-range-facet>
```
