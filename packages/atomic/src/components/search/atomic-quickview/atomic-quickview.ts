...
@bindings()
@withTailwindStyles
export class AtomicQuickview extends LitElement implements InitializableComponent<Bindings> {
  ...
  constructor() {
    ...
    new ValidatePropsController(this, () => ({sandbox: this.sandbox}), AtomicQuickview.propsSchema);
  }
