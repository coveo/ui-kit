...
export class AtomicFieldCondition {
   ...
   *
   * Use only when the condition you need to define can’t be expressed through existing `if-defined`,`if-not-defined`,`must-match`, etc. markup attributes of the component.
