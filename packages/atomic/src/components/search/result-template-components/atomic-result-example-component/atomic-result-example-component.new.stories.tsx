...
const meta: Meta = {
  component: 'atomic-result-example-component',
  title: 'Atomic/ResultList/ExampleComponent',
  id: 'atomic-result-example-component',
...
export const Default: Story = {
  name: 'atomic-result-example-component',
};
