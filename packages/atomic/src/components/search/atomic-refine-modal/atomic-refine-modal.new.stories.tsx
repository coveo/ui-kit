...
export const DependentFacetOrderWithoutFix: Story = {
  name: 'Dependent Facet Order (Without Fix)',
  tags: ['test'],
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Reproduces KIT-6177 before the fix. After YouTubeVideo is selected, Language appears after Type instead of between File Type and Type.',
      },
    },
  },
  beforeEach: () => {
  ...
  play: async (context) => {
    ...
    if (facetLabels.join() !== 'File Type,Type,Language (dependent)') {
