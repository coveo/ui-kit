...
You can [define custom templates](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-display-results-introduction--docs#defining-a-result-template) for how results and their children are displayed:
