...
The facet manager leverages Coveo's [Dynamic Navigation Experience](https://docs.coveo.com/en/3383) to automatically order facets based on their relevance to the current search query.
