 ...
 *
 * **Sorting facets** - Reorders facets based on the search response to show the most relevant facets first.
 * **Managing visibility** - Controls which facets should be visible or hidden based on available values and dependencies.
 * **Managing collapse state** - Automatically expands or collapses facets based on the `collapse-facets-after` property.
 *
