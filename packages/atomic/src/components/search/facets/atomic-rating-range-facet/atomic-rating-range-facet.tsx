  ...
  implements InitializableComponent, BaseFacet<NumericFacet>
{
   ...
   * ```html
   *  <atomic-rating-range-facet tabs-included='["tabIDA", "tabIDB"]'></atomic-rating-range-facet>
   * ```
   ...
   * Set this property as a stringified JSON array, e.g.,
   * ```html
   *  <atomic-rating-range-facet tabs-excluded='["tabIDA", "tabIDB"]'></atomic-rating-range-facet>
   * ```
