  ...
  private renderDropdownButton() {
    ...
    return (
      <Button
        ...
        class={`hover:border-primary-light focus-visible:border-primary-light group box-border flex h-full min-w-[6rem] max-w-[15rem] items-center rounded p-2.5 hover:border focus-visible:border ${
          this.isOpen
