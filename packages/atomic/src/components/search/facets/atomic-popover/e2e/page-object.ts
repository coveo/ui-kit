...
export class PopoverPageObject extends BasePageObject {
  ...
  get facetContainer(): Locator {
    return this.page.locator('atomic-popover [part="facet"]');
  }

  get valueLabel(): Locator {
    return this.page.locator('atomic-popover [part="value-label"]');
  }

  get valueCount(): Locator {
    return this.page.locator('atomic-popover [part="value-count"]');
  }
