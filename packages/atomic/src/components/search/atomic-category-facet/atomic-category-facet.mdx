...
Instead of selecting the facet value directly, this allows them to navigate hierarchically and determine the right starting point. // W: Glossary.Facet:A glossary entry exists for 'facet'. Use the glossary snippet instead.
