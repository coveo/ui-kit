...
- **Agent Mode**: Enables a fixed-height, scrollable answer container when `agent-id` is set
...
```html
<atomic-generated-answer collapsible max-collapsed-height="20">
...
Render the answer with a fixed height and scrollable content by setting an agent identifier:

```html
<atomic-generated-answer agent-id="my-agent-id"></atomic-generated-answer>
```

When `agent-id` is set:

- The answer container uses a fixed height and scrolls vertically.
- `collapsible` and `max-collapsed-height` are ignored.
...
```html
<atomic-generated-answer answer-configuration-id="my-config-id">
</atomic-generated-answer>
```
...
<atomic-generated-answer tabs-included='["search", "knowledge"]'>
</atomic-generated-answer>

<!-- Hide on specific tabs -->
<atomic-generated-answer tabs-excluded='["images", "videos"]'>
</atomic-generated-answer>
```
...
<atomic-generated-answer>
  <div slot="no-answer-message">
    Sorry, we couldn't generate an answer for your query. Please try rephrasing
    your question.
  </div>
</atomic-generated-answer>
```
...
- `--atomic-generated-answer-fixed-height` - Fixed height of the answer container when `agent-id` is set
