  ...
  return (
    <li key={props.displayValue} class="h-32">
      <button
        ...
        class={`value-box box-border w-full h-full flex flex-col items-center rounded text-on-background hover:border-primary-light focus:border-primary-light focus:outline-none py-2 px-1 ellipsed ${
