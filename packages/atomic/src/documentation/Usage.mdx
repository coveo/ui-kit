...
While this import is optional, if you don't import it you'll need to [define its variables](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-themes-and-visual-customization--docs) yourself.
...
**Example**
   ...
   You use the Atomic Vue wrapper and need to [Bind the custom elements to the window object](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-in-a-framework-usage-in-a-vue-project--docs).
...
You can also create your own result templates with custom styles (see [Defining a result template](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-display-results-introduction--docs)).
To learn more, see [Defining a Result Template](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-display-results-introduction--docs).
