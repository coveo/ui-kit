...
<Meta title="Usage/Information/Usage Analytics/Event Protocol" />

# Atomic Usage Analytics - Event Protocol
...
> The controller can automatically extract relevant data from result items and log click events for you, as in the following [custom Atomic component](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-custom-web-components--docs) example.
...
> **Note**
>
> For the purpose of using [content recommendations](https://docs.coveo.com/en/1016/) models however, log [view events](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-usage-analytics-event-protocol-log-view-events-with-ep--docs).
> Atomic components or Headless controllers won't log view events for you.
> Use the [Relay library](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-usage-analytics-event-protocol-log-view-events-with-ep--docs).
