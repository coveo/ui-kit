...
<Meta title="Information/Product lifecycle" />

# Product lifecycle

The [Atomic library](https://docs.coveo.com/en/lcdf0264/) is an evolving product which is continuously delivering new features and improvements.
This high velocity of innovation, combined with ever-changing dependencies (such as Node.js and [Headless](https://docs.coveo.com/en/lcdf0493/) updates), means that certain legacy frameworks, methods, or features must be deprecated.

This article describes the official product lifecycle for each version of the Atomic library and its components.
...
The latest version of the Atomic library can be downloaded from [npm](https://www.npmjs.com/package/@coveo/atomic).
...
| v1 | September 2021 | December 2022 | March 2023 | September 2024 |
...
New Atomic releases after this date are no longer tested or supported with the listed package version or component.
...
As of `@coveo/atomic` v3.12.0, the following framework versions are supported:
...
Support for newer versions of these frameworks may be added in either major or minor updates.
