...
<Meta title="Usage Analytics/Atomic usage analytics coveo ua" />
...
> Take a look at the [Log view events with Coveo UA](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-usage-analytics-coveo-ua-log-view-events-with-coveo-ua--docs) article to understand how to send view events.
...
To use this property in Atomic v3, you need to [set the `analyticsMode` to `legacy`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/upgrade-v2-to-v3--docs#migration-to-coveo-event-protocol) during the initialization.
