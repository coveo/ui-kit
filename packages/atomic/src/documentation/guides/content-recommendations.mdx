...
<Meta title="Guides/Content recommendations" />
...
> To display recommendations with Atomic, configure a [CR model](https://docs.coveo.com/en/3387/) and [log the required usage analytics events](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-usage-analytics-introduction--docs).
...
For a more detailed guide on how to customize your components, see [Themes and visual customization](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-themes-and-visual-customization--docs).
...
Recommendation components can be used [out of the box](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-in-a-framework-usage-in-a-vue-project--docs) in a [Vue.js](https://vuejs.org/) project.

To use recommendations in others frameworks such as [React](https://reactjs.org/) or [Angular](https://angular.io/), the [Atomic React wrapper](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-in-a-framework-use-the-react-wrapper--docs) and [Atomic Angular wrapper](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-in-a-framework-use-the-angular-wrapper--docs) expose the components described in this article.
