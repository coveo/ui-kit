...
<Meta title="Guides/Display results/Introduction" />
...
* [Displaying results as a list or grid](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-display-results-display-results-as-a-list-or-grid--docs)

* [Displaying results as a table](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-display-results-display-results-as-a-table--docs)
...
To display results hierarchically, see [Implement folding](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-display-results-implement-folding--docs).
...
If you don't need a deep level of customization and want to render results following Coveo's mobile-friendly design, use [result sections](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-display-results-use-result-sections--docs).
...
* [Display results as a table](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-display-results-display-results-as-a-table--docs)

* [Implement folding](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-display-results-implement-folding--docs)
