...
<Meta title="Guides/Frameworks/Usage in a Vue project" />
...
Installing Atomic in your Vue project is very similar to [installing Atomic](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-introduction--docs) outside of Vue.
However, there are some extra steps if you choose to [install Atomic via npm](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-in-a-framework-usage-in-a-vue-project--docs).
...
The Atomic package allows you to customize your components by defining CSS variables in your own stylesheet (see [Themes and visual customization](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-themes-and-visual-customization--docs)).
...
1. Initialization (see [Use components to create a search interface](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-introduction--docs)).
