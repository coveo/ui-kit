...
<Meta title="Guides/Upgrade/v1 to v2" />
...
### [`atomic-result`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-result-list--default)
...
### [`atomic-rating-facet`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-rating-facet--default):
...
### [`atomic-refine-modal`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-refine-modal--default):
...
### [`atomic-result-list`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-result-list--default) and [`atomic-folded-result-list`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-folded-result-list--default)

The `fields-to-include` were removed from `atomic-result-list` and `atomic-folded-result-list`.
Use the `fields-to-include` in [`atomic-search-interface`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-search-interface--default) instead.
...
The [`atomic-query-summary`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-query-summary--default) `enable-duration` attribute has been removed.
...
### [`atomic-category-facet`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-category-facet--default) Styling
...
### [`atomic-result-link`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-result-link--default) and [`atomic-result-printable-uri`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-result-printable-uri--default)
...
### [Result sections](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-display-results-use-result-sections--docs)
...
> **Note**
>
> A case where you can see two suggestion panels is when implementing [instant results](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-display-results-display-instant-results--docs).
...
### [Atomic React Wrapper](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-in-a-framework-use-the-react-wrapper--docs)
