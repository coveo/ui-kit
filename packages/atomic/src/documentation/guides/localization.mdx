...
![Atomic changing interface language](/assets/images/atomic-change-language.png)
...
![Atomic modify text value](/assets/images/atomic-add-or-modify-text-value.png)
...
![Atomic changing facet caption](/assets/images/atomic-facet-caption.png)

Result template outcome example:

![Atomic changing result template caption](/assets/images/atomic-result-template-caption.png)
...
![Atomic changing the dev language](/assets/images/atomic-dev-language.png)
...
![Atomic changing facet label](/assets/images/atomic-facet-label.png)
