...
If you're using a custom theme, [customize the colors and font sizes](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-themes-and-visual-customization--docs) in your interface to conform to accessibility standards.
...
> **Note**
>
> This is only relevant if you use [result sections](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-display-results-use-result-sections--docs) in your result template.
...
The `i18next` bindings are required when you want to support [localization](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-localization--docs).
...
3. If the field you want to add is populated, add it to the `information` array, using `i18n` [dynamic values](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-localization--docs) for localization.
