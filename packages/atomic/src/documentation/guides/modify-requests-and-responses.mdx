...
<Meta title="Guides/Modify requests and responses" />
...
> You can [use them in Atomic](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-access-headless-through-atomic--docs) as well.
>
