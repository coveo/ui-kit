...
<Meta title="Guides/Custom web components" />

# Custom web components

[Coveo Atomic](https://docs.coveo.com/en/lcdf0264/) components fulfill most use cases, follow best UX practices, and are visually [customizable](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-themes-and-visual-customization--docs).
...
8. (Optional) This line and the following are only relevant if your component needs to re-render when the [Atomic](https://docs.coveo.com/en/lcdf0264/) [i18n](https://www.i18next.com/) language changes (see [Localization](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/guides-localization--docs)).
