...
> To display recommendations with Atomic, configure a [CR model](https://docs.coveo.com/en/3387/) and [logged the required usage analytics events](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-usage-analytics-introduction--docs).
