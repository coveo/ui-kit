...
<Meta title="Usage/Guides/Display results/Introduction" />
...
The [`atomic-result-list`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-result-list--default) component can display results as a list, grid, or table.

You can find extended documentation on how to use this component in the following:

* [Displaying results as a list or grid](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-display-results-display-results-as-a-list-or-grid--docs)

* [Displaying results as a table](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-display-results-display-results-as-a-table--docs)
...
The [`atomic-folded-result-list`](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-folded-result-list--default) component can display results hierarchically.

To display results hierarchically, see [Implement folding](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-display-results-implement-folding--docs).
...
To display result-specific information, use [result template components](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-result-template--default).
...
If you don't need a deep level of customization and want to render results following Coveo's mobile-friendly design, use [result sections](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-display-results-use-result-sections--docs).
...
* [Display results as a table](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-display-results-display-results-as-a-table--docs)

* [Implement folding](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-display-results-implement-folding--docs)
