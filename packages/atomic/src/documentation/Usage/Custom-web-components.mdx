...
<Meta title="Usage/Information/Custom web components" />
...
> In a real life scenario, use [result-field-condition](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-field-condition--default) and [atomic-result-text](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/story/atomic-result-text--default).
