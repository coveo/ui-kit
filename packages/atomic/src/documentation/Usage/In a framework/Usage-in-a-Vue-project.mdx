...
<Meta title="Usage/Guides/Frameworks/Usage in a Vue project" />
...
Installing Atomic in your Vue project is very similar to [installing Atomic](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-introduction--docs) outside of Vue.
However, there are some extra steps if you choose to [install Atomic via npm](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-in-a-framework-usage-in-a-vue-project--docs).
...
1. Initialization (see [Use components to create a search interface](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-introduction--docs)).
