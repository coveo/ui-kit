...
3. If the field you want to add is populated, add it to the `information` array, using `i18n` [dynamic values](https://static.cloud.coveo.com/atomic/v3/storybook/index.html?path=/docs/usage-localization--docs#use-dynamic-values) for localization.
