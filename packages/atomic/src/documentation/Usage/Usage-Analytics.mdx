...
<Meta title="Usage/Usage Analytics/Introduction" />
...
Since version 2.78.0, Coveo Atomic supports two tracking protocols: the [Coveo UA Protocol](https://docs.coveo.com/en/atomic/latest/usage/atomic-usage-analytics/atomic-coveo-ua/) and the new [Event Protocol (EP)](https://docs.coveo.com/en/atomic/latest/usage/atomic-usage-analytics/atomic-ep/).
