...
<Meta title="Usage/Information/Usage Analytics/Log view events with Coveo UA" />
...
8. `CONTEXT_KEY`/`<CUSTOM_CONTEXT_VALUE>`: (Optional) The [user context](https://docs.coveo.com/en/3389/) key-value pairs to pass for more personalized recommendations.
