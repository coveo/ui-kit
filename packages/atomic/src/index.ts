...
export {fetchProductContext} from './components/commerce/product-template-component-utils/product-template-controllers';
...
export {resultContext} from './components/search/result-template-component-utils/stencil-result-template-decorators';
export {
  initializeBindings,
