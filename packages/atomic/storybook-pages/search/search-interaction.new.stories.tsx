...
const meta: Meta = {
  component: 'search-interaction-page',
  title: 'Search/Interaction Examples',
  id: 'search-interaction-page',
  parameters: {
    ...parameters,
    layout: 'fullscreen',
    msw: {
  ...
  `,
  play: async (context) => {
    // Step 1: Initialize the search interface — test a11y in idle/initial state
    ...
    // Step 2: Type a query to test a11y in query-suggestion state
    const searchBox = context.canvasElement.querySelector('atomic-search-box');
    ...
    // Step 3: Submit the query to test a11y in results-loaded state
    await searchInterface!.executeFirstSearch();
  },
};
...
export const Default: Story = {
  name: 'Search Interaction Page',
};

export const WithQuery: Story = {
  name: 'Search With Query',
  play: async (context) => {
    // Step 1: Initialize the search interface
    await initializeSearchInterface(context.canvasElement);
    const searchInterface = context.canvasElement.querySelector(
      'atomic-search-interface'
    );
    ...
    // Step 3: Submit the query and wait for results to test a11y in results-loaded state
    await searchInterface!.executeFirstSearch();
  },
};
