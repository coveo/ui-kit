...
export class CoveoInsightClient {
  ...
  public logCreateArticle(
    ...
    return this.logCustomEvent(
      ...
      metadata
        ? {...generateMetadataToSend(metadata, false), ...createArticleMetadata}
        : createArticleMetadata
    );
  }
  ...
  public logOpenSmartSnippetInlineLink(
    ...
    return this.logClickEvent(
      ...
      metadata
        ? {...generateMetadataToSend(metadata, false), ...identifierAndLink}
        : identifierAndLink
    );
  }
  ...
  public logDislikeGeneratedAnswer(
    generatedAnswerMetadata: GeneratedAnswerBaseMeta,
    metadata?: CaseMetadata
  ) {
    return this.logCustomEvent(
  ...
  public logGeneratedAnswerHideAnswers(
    generatedAnswerMetadata: GeneratedAnswerBaseMeta,
    metadata?: CaseMetadata
  ) {
    return this.logCustomEvent(
  ...
  public logGeneratedAnswerShowAnswers(
    generatedAnswerMetadata: GeneratedAnswerBaseMeta,
    metadata?: CaseMetadata
  ) {
    return this.logCustomEvent(
  ...
  public logGeneratedAnswerExpand(
    generatedAnswerMetadata: GeneratedAnswerBaseMeta,
    metadata?: CaseMetadata
  ) {
    return this.logCustomEvent(
  ...
  public logGeneratedAnswerCollapse(
    generatedAnswerMetadata: GeneratedAnswerBaseMeta,
    metadata?: CaseMetadata
  ) {
    return this.logCustomEvent(
  ...
  public async logSearchEvent(
    ...
    return this.coveoAnalyticsClient.sendSearchEvent(
      await this.getBaseSearchEventRequest(event, metadata)
    );
  }
  ...
  public logTriggerNotify(
    ...
    return this.logCustomEvent(
      ...
      metadata
        ? {...generateMetadataToSend(metadata, false), ...triggerNotifyMetadata}
        : triggerNotifyMetadata
    );
  }
