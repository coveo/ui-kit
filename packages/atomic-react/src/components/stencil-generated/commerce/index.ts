...
export const AtomicInsightUserActionsModal = /*@__PURE__*/createReactComponent<JSX.AtomicInsightUserActionsModal, HTMLAtomicInsightUserActionsModalElement>('atomic-insight-user-actions-modal');
