...
export const AtomicChildResult = /*@__PURE__*/createReactComponent<JSX.AtomicChildResult, HTMLAtomicChildResultElement>('atomic-child-result');
export const AtomicChildrenResultList = /*@__PURE__*/createReactComponent<JSX.AtomicChildrenResultList, HTMLAtomicChildrenResultListElement>('atomic-children-result-list');
