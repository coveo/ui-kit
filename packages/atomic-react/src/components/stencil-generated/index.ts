...
export const AtomicProductListingCategoryFacet = /*@__PURE__*/createReactComponent<JSX.AtomicProductListingCategoryFacet, HTMLAtomicProductListingCategoryFacetElement>('atomic-product-listing-category-facet');
export const AtomicProductListingInterface = /*@__PURE__*/createReactComponent<JSX.AtomicProductListingInterface, HTMLAtomicProductListingInterfaceElement>('atomic-product-listing-interface');
export const AtomicProductListingProductRatingRangeFacet = /*@__PURE__*/createReactComponent<JSX.AtomicProductListingProductRatingRangeFacet, HTMLAtomicProductListingProductRatingRangeFacetElement>('atomic-product-listing-product-rating-range-facet');
