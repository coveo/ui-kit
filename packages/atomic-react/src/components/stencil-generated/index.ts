...
export const AtomicInsightgeneratedAnswer = /*@__PURE__*/createReactComponent<JSX.AtomicInsightgeneratedAnswer, HTMLAtomicInsightgeneratedAnswerElement>('atomic-insightgenerated-answer');
