...
export const AtomicCommerceResultList = /*@__PURE__*/createReactComponent<JSX.AtomicCommerceResultList, HTMLAtomicCommerceResultListElement>('atomic-commerce-result-list');
