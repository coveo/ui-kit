...
export const AtomicSmartSnippetSource = /*@__PURE__*/createReactComponent<JSX.AtomicSmartSnippetSource, HTMLAtomicSmartSnippetSourceElement>('atomic-smart-snippet-source');
