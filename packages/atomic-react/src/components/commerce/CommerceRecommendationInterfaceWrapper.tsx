...
import {AtomicCommerceRecommendationInterface} from '../stencil-generated/commerce/index.js';
...
interface WrapperProps
  extends Omit<
    JSX.AtomicCommerceRecommendationInterface,
...
export const InterfaceWrapper = (
  ...
  const interfaceRef =
    useRef<HTMLAtomicCommerceRecommendationInterfaceElement>(null);
