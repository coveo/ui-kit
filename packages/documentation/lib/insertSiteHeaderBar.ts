export const insertSiteHeaderBar = (assetsPath: string) => {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (header) {
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
              ...
              <div class="btn-toolbar navbar-buttons flex-nowrap justify-content-center justify-content-md-end" role="toolbar"
                ...
                <div class="btn-group py-81 py-md-0" role="group" aria-label="Navigation links">
                  <button type="button" class="btn site-navbar-btn" id="tsd-edit-github-btn" style="display:none">
                    <a id="tsd-edit-github-link" href="#" target="_blank" rel="noopener noreferrer" title="Edit in GitHub" aria-label="Edit in GitHub" class="navbar-link fs-75 fw-400 d-inline-flex align-items-center justify-content-center">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" style="flex-shrink:0;display:block">
      ...
      const editBtn = document.getElementById('tsd-edit-github-btn');
      const editLink = document.getElementById('tsd-edit-github-link');
      if (githubMeta && editBtn && editLink) {
        (editLink as HTMLAnchorElement).href =
          githubMeta.getAttribute('content') ?? '';
