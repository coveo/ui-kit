...
@ProxyCmp({
  inputs: ['reflectStateInUrl'],
  methods: ['initialize', 'initBindings'],
  defineCustomElementFn: () => {customElements.get('atomic-commerce-url-manager') || customElements.define('atomic-commerce-url-manager', LitAtomicCommerceUrlManager);}
})
@Component({
  selector: 'atomic-commerce-url-manager',
  standalone: false,
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
