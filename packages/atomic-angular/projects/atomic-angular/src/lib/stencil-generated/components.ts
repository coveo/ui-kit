...
@ProxyCmp({
  inputs: ['open'],
  methods: [],
  defineCustomElementFn: () => {customElements.get('atomic-relevance-inspector') || customElements.define('atomic-relevance-inspector', LitAtomicRelevanceInspector);}
})
@Component({
...
export declare interface AtomicRelevanceInspector extends LitAtomicRelevanceInspector {
