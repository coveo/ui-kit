...
@Component({
  selector: 'stencil-atomic-commerce-facets',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: ['collapseFacetsAfter'],
})
export class StencilAtomicCommerceFacets {
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
...
export declare interface StencilAtomicCommerceFacets extends Components.StencilAtomicCommerceFacets {}
