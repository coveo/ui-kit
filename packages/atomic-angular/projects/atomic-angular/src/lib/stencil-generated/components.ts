...
@ProxyCmp({
  inputs: ['label', 'range', 'facet'],
  methods: ['initialize'],
  defineCustomElementFn: () => {customElements.get('atomic-commerce-facet-number-input') || customElements.define('atomic-commerce-facet-number-input', LitAtomicCommerceFacetNumberInput);}
})
@Component({
...
export class AtomicCommerceFacetNumberInput {
  ...
  constructor(c: ChangeDetectorRef, el: ElementRef, protected z: NgZone) {
    ...
    proxyOutputs(this, this.el, ['atomic-number-input-apply']);
  }
}

export declare interface AtomicCommerceFacetNumberInput extends LitAtomicCommerceFacetNumberInput {
  'atomic-number-input-apply': EventEmitter<CustomEvent<any>>;
}
