...
@ProxyCmp({
  inputs: ['analytics', 'engine', 'fieldsToInclude', 'i18n', 'iconAssetsPath', 'language', 'languageAssetsPath', 'localizationCompatibilityVersion', 'logLevel', 'nonce', 'pipeline', 'searchHub', 'timezone'],
...
@ProxyCmp({
  inputs: ['analytics', 'enableRelevanceInspector', 'engine', 'fieldsToInclude', 'i18n', 'iconAssetsPath', 'language', 'languageAssetsPath', 'localizationCompatibilityVersion', 'logLevel', 'nonce', 'pipeline', 'reflectStateInUrl', 'scrollContainer', 'searchHub', 'timezone'],
