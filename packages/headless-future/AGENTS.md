...
The headless-future package is private, under active development, and not used
...
- Ensure that any architectural changes you suggest or make satisfy the requirements of `headless-future/docs/internal/adr/ADR-000-architecture-decision-charter.md`.
