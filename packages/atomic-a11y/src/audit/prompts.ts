...
/**
 * Keys for the differential audit call.
 * Same as MERGED_CALL1_3_KEYS — the differential prompt evaluates
 * the same 15 criteria but references archetype results as baseline.
 */
export const DIFFERENTIAL_KEYS = MERGED_CALL1_3_KEYS;
