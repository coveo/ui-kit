// TODO: document this interface and its usage in the README
...
export const INTERACTION_PROTOCOLS: InteractionProtocol[] = [
  ...
  },
  {
    ...
    stateAttributes: [],
    expectsLiveRegion: true,
    liveRegionSelector: 'atomic-aria-live div[id*="query-summary"]',
    actions: [{name: 'observe-load', keys: [], focusFirst: false}],
  },
  {
    role: 'no-results',
    ...
    stateAttributes: [],
    expectsLiveRegion: true,
    liveRegionSelector: 'atomic-aria-live div[id*="no-results"]',
    actions: [{name: 'observe-load', keys: [], focusFirst: false}],
  },
  {
    role: 'query-error',
    ...
    stateAttributes: [],
    expectsLiveRegion: true,
    liveRegionSelector: 'atomic-aria-live div[id*="query-error"]',
    actions: [{name: 'observe-load', keys: [], focusFirst: false}],
  },
  {
    role: 'generated-answer',
    selector: 'atomic-generated-answer',
    stateAttributes: [],
    expectsLiveRegion: true,
    liveRegionSelector: 'atomic-aria-live div[id*="generated-answer"]',
    actions: [{name: 'observe-load', keys: [], focusFirst: false}],
  },
  {
    role: 'notifications',
    ...
    stateAttributes: [],
    expectsLiveRegion: true,
    liveRegionSelector: 'atomic-aria-live div[id*="notifications"]',
    actions: [{name: 'observe-load', keys: [], focusFirst: false}],
  },
  {
    role: 'facet-search',
    selector: 'atomic-facet input[type="search"]',
    stateAttributes: [],
    expectsLiveRegion: true,
    liveRegionSelector: 'atomic-aria-live div[id*="facet"]',
    actions: [{name: 'search-facet', keys: ['a', 'b', 'c'], focusFirst: false}],
  },
  {
    role: 'category-facet-select',
    selector: 'atomic-category-facet button[part="value-label"]',
    stateAttributes: [],
    expectsLiveRegion: true,
    liveRegionSelector: 'atomic-aria-live div[id*="facet"]',
    actions: [{name: 'select-category', keys: ['Enter'], focusFirst: false}],
  },
  {
    role: 'color-facet-select',
    selector: 'atomic-color-facet button[part="value-label"]',
    stateAttributes: [],
    expectsLiveRegion: true,
    liveRegionSelector: 'atomic-aria-live div[id*="facet"]',
    actions: [{name: 'select-color', keys: ['Enter'], focusFirst: false}],
  },
  {
    role: 'search-suggestions',
    selector: 'atomic-search-box input',
    stateAttributes: [],
    expectsLiveRegion: true,
    liveRegionSelector: 'atomic-aria-live div[id*="suggestions"]',
    actions: [{name: 'navigate-suggestions', keys: ['ArrowDown', 'ArrowDown'], focusFirst: false}],
  },
  {
    role: 'quickview',
    selector: 'atomic-quickview button',
    stateAttributes: [],
    expectsLiveRegion: true,
    liveRegionSelector: 'atomic-aria-live div[id*="quickview"]',
    actions: [{name: 'open-quickview', keys: ['Enter'], focusFirst: false}],
  },
];
