...
const criterionMetadataMap: Record<string, CriterionMetadata> = Object.fromEntries(
...
export function getCriterionMetadata(criterionId: string): CriterionMetadata | undefined {
