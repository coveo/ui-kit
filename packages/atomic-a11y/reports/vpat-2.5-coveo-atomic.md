...
**Name of Product/Version:** Coveo Atomic 3.59.6
...
| ---------------------------------------------------------- | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1.1.1 Non-text Content                                     | Supports          | Supports — automated axe-core found no violations across 172 component(s).                                                                                                                                                                                                         |
...
| 1.3.1 Info and Relationships                               | Supports          | Supports — automated axe-core found no violations across 172 component(s); interactive keyboard testing passed across 2 component(s).                                                                                                                                              |
...
| 1.4.1 Use of Color                                         | Supports          | Supports — automated axe-core found no violations across 172 component(s).                                                                                                                                                                                                         |
| 1.4.2 Audio Control                                        | Not Applicable    | Atomic does not include components that auto-play audio.                                                                                                                                                                                                                           |
| 2.1.1 Keyboard                                             | Supports          | Supports — automated axe-core found no violations across 174 component(s); interactive keyboard testing passed across 34 component(s).                                                                                                                                             |
...
| 2.4.4 Link Purpose (In Context)                            | Supports          | Supports — automated axe-core found no violations across 172 component(s).                                                                                                                                                                                                         |
...
| 3.3.2 Labels or Instructions                               | Supports          | Supports — automated axe-core found no violations across 172 component(s).                                                                                                                                                                                                         |
| 3.3.7 Redundant Entry                                      | Not Applicable    | Atomic does not include multi-step forms that require redundant data entry.                                                                                                                                                                                                        |
| 4.1.2 Name, Role, Value                                    | Supports          | Supports — automated axe-core found no violations across 172 component(s); interactive keyboard testing passed across 4 component(s).                                                                                                                                              |
...
| 1.3.5 Identify Input Purpose                    | Supports          | Supports — automated axe-core found no violations across 172 component(s).                                                                                                                                                                    |
| 1.4.3 Contrast (Minimum)                        | Supports          | Supports — automated axe-core found no violations across 172 component(s).                                                                                                                                                                    |
| 1.4.4 Resize text                               | Supports          | Supports — automated axe-core found no violations across 172 component(s).                                                                                                                                                                    |
...
| 1.4.12 Text Spacing                             | Supports          | Supports — automated axe-core found no violations across 172 component(s).                                                                                                                                                                    |
...
| 2.5.8 Target Size (Minimum)                     | Supports          | Supports — automated axe-core found no violations across 172 component(s).                                                                                                                                                                    |
| 3.1.2 Language of Parts                         | Supports          | Supports — automated axe-core found no violations across 172 component(s).                                                                                                                                                                    |
